...
", GREEN, BLUE, RED, YELLOW) + NOCOLOR);
        ...
        public static void PrintUsage()
        {
            ...
            Console.WriteLine(LCYAN + "        -vulnpackages" + GRAY + "       Send installed application names/versions to HackTricks for an online vulnerability check. Also enabled by 'all'." + NOCOLOR);
