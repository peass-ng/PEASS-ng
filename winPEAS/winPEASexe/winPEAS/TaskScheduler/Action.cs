...
namespace Microsoft.Win32.TaskScheduler
{
	...
	public class ComHandlerAction : Action, IBindAsExecAction
	{
		...
		public override string ToString() => string.Format(winPEAS.Properties.Resources.ComHandlerAction, ClassId, Data, Id, ClassName);
	...
	public sealed class EmailAction : Action, IBindAsExecAction
	{
		...
		/// </summary>
		/// <returns>String representation of this action.</returns>
		public override string ToString() => string.Format(winPEAS.Properties.Resources.EmailAction, Subject, To, Cc, Bcc, From, ReplyTo, Body, Server, Id);
	...
	public class ExecAction : Action
	{
		...
		/// </summary>
		/// <returns>String representation of this action.</returns>
		public override string ToString() => string.Format(winPEAS.Properties.Resources.ExecAction, Path, Arguments, WorkingDirectory, Id);
	...
	public sealed class ShowMessageAction : Action, IBindAsExecAction
	{
		...
		/// </summary>
		/// <returns>String representation of this action.</returns>
		public override string ToString() => string.Format(winPEAS.Properties.Resources.ShowMessageAction, Title, MessageBody, Id);
