...
if [ "$inContainer" ]; then
  ...
  print_info "https://book.hacktricks.wiki/en/linux-hardening/linux-basics/linux-privilege-escalation/container-security/privileged-containers.html#writable-bind-mounts"
