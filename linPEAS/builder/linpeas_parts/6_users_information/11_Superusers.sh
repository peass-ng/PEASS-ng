...
print_2title "Superusers and UID 0 users (T1087.001)" "T1087.001"
...
echo ""
print_3title "Users with UID 0 in /etc/passwd (T1087.001)" "T1087.001"
...
echo ""
print_3title "Users with sudo privileges in sudoers (T1087.001)" "T1087.001"
