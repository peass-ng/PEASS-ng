...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"bind\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \"system.d\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"bind\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"logstash\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"environments\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"bind\" -o -name \"mysql\" -o -name \"neo4j\" -o -name \".bluemix\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"seeddms*\" -o -name \"cacti\" -o -name \"ldap\" -o -name \".vnc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"*knockd*\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"ssh*config\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"sess_*\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"sess_*\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"agent*\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.timer\" -o -name \"*.service\" -o -name \"*.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_USR=`eval_bckgrd "find /usr -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"ssh*config\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \".google_authenticator\" -o -name \"software\" -o -name \"access_tokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ws_ftp.ini\" -o -name \"credentials.db\" -o -name \".*_history.*\" -o -name \"ddclient.conf\" -o -name \"rsyncd.secrets\" -o -name \".env\" -o -name \"pagefile.sys\" -o -name \"*.viminfo\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattend.inf\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \".sudo_as_admin_successful\" -o -name \"ipsec.conf\" -o -name \".plan\" -o -name \"*.crt\" -o -name \"secrets.yml\" -o -name \"docker-compose.yml\" -o -name \"sysprep.xml\" -o -name \"krb5.conf\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \".github\" -o -name \"ipsec.secrets\" -o -name \"AzureRMContext.json\" -o -name \"drives.xml\" -o -name \"mongod*.conf\" -o -name \"web*.config\" -o -name \"*.gnupg\" -o -name \"*credential*\" -o -name \"wp-config.php\" -o -name \"my.ini\" -o -name \"authorized_keys\" -o -name \"config.php\" -o -name \"credentials\" -o -name \"debian.cnf\" -o -name \"Ntds.dit\" -o -name \"*.db\" -o -name \"mosquitto.conf\" -o -name \"SecEvent.Evt\" -o -name \"*.pfx\" -o -name \"SAM\" -o -name \"default.sav\" -o -name \"racoon.conf\" -o -name \"fastcgi_params\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \"*.kdbx\" -o -name \"printers.xml\" -o -name \"id_rsa*\" -o -name \"groups.xml\" -o -name \".gitconfig\" -o -name \"mariadb.cnf\" -o -name \"*vnc*.xml\" -o -name \"index.dat\" -o -name \"backups\" -o -name \"kcpassword\" -o -name \"passbolt.php\" -o -name \"ftp.config\" -o -name \"docker.socket\" -o -name \"kadm5.acl\" -o -name \"gvm-tools.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"creds*\" -o -name \"*.keystore\" -o -name \"hostapd.conf\" -o -name \"*.pem\" -o -name \"000-default.conf\" -o -name \"ffftp.ini\" -o -name \"datasources.xml\" -o -name \"sess_*\" -o -name \"protecteduserkey.bin\" -o -name \"SYSTEM\" -o -name \"*.pgp\" -o -name \"secrets.ldb\" -o -name \"*.sqlite3\" -o -name \"elasticsearch.y*ml\" -o -name \"known_hosts\" -o -name \"*.swp\" -o -name \"authorized_hosts\" -o -name \"*.socket\" -o -name \"psk.txt\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \".pypirc\" -o -name \"setupinfo.bak\" -o -name \"sitemanager.xml\" -o -name \"Dockerfile\" -o -name \"snmpd.conf\" -o -name \"pgadmin*.db\" -o -name \"KeePass.ini\" -o -name \"backup\" -o -name \"appcmd.exe\" -o -name \"sssd.conf\" -o -name \".erlang.cookie\" -o -name \".wgetrc\" -o -name \"KeePass.config*\" -o -name \"unattend.txt\" -o -name \"security.sav\" -o -name \"tomcat-users.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \".msmtprc\" -o -name \".vault-token\" -o -name \"settings.php\" -o -name \"hosts.equiv\" -o -name \"gitlab.rm\" -o -name \"*.key\" -o -name \".rhosts\" -o -name \"autologin.conf\" -o -name \"unattend.xml\" -o -name \".secrets.mkey\" -o -name \".recently-used.xbel\" -o -name \"*.jks\" -o -name \"wsl.exe\" -o -name \"*.cer\" -o -name \"winscp.ini\" -o -name \".bashrc\" -o -name \"scclient.exe\" -o -name \"influxdb.conf\" -o -name \"sysprep.inf\" -o -name \"kibana.y*ml\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"system.sav\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"scheduledtasks.xml\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \"autologin\" -o -name \"https.conf\" -o -name \"*.sqlite\" -o -name \"ntuser.dat\" -o -name \"*.der\" -o -name \"sentry.conf.py\" -o -name \"wcx_ftp.ini\" -o -name \"*.ovpn\" -o -name \"KeePass.enforced*\" -o -name \"recentservers.xml\" -o -name \"*.rdg\" -o -name \"*vnc*.c*nf*\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \"legacy_credentials.db\" -o -name \"RDCMan.settings\" -o -name \"filezilla.xml\" -o -name \"NetSetup.log\" -o -name \"httpd.conf\" -o -name \".k5login\" -o -name \"cloud.cfg\" -o -name \"*.keyring\" -o -name \"setupinfo\" -o -name \"postgresql.conf\" -o -name \"https-xampp.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \".git\" -o -name \"iis6.log\" -o -name \"id_dsa*\" -o -name \"access_tokens.db\" -o -name \".profile\" -o -name \"redis.conf\" -o -name \"supervisord.conf\" -o -name \"*.ftpconfig\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"pgsql.conf\" -o -name \"*vnc*.txt\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"krb5.keytab\" -o -name \"passwd\" -o -name \"rsyncd.conf\" -o -name \"*.gpg\" -o -name \"server.xml\" -o -name \"AppEvent.Evt\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/applications|^/mnt|^/lib64|^$GREPHOMESEARCH|^/media|^/snap|^/systemd|^/system|^/opt|^/tmp|^/bin|^/etc|^/usr|^/.cache|^/sys|^/lib32|^/srv|^/var|^/private|^/cdrom|^/lib|^/run|^/sbin" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/applications|^/mnt|^/lib64|^$GREPHOMESEARCH|^/media|^/snap|^/systemd|^/system|^/opt|^/tmp|^/bin|^/etc|^/usr|^/.cache|^/sys|^/lib32|^/srv|^/var|^/private|^/cdrom|^/lib|^/run|^/sbin" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/applications|^/mnt|^/lib64|^$GREPHOMESEARCH|^/media|^/snap|^/systemd|^/system|^/opt|^/tmp|^/bin|^/etc|^/usr|^/.cache|^/sys|^/lib32|^/srv|^/var|^/private|^/cdrom|^/lib|^/run|^/sbin" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/tmp|^/mnt|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E '/default/settings.php' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E 'moodle/config.php' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_KERBEROS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E '/lib' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E 'README.gnupg' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/usr|^/var|^/etc" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_CDROM\n$FIND_DIR_APPLICATIONS"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_USR\n$FIND_SYSTEM\n$FIND_BIN\n$FIND_ETC\n$FIND_MNT\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_CDROM\n$FIND_LIB32\n$FIND_HOMESEARCH"  | grep -E "^/snap|^/applications|^/var|^/private|^/usr|^/cdrom|^/.cache|^/mnt|^/etc|^$GREPHOMESEARCH|^/opt|^/sbin|^/media|^/tmp|^/bin|^/srv" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
