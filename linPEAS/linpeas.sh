...
PORTS=""
QUIET=""
CHECKS="system_information,container,available_software,procs_crons_timers_srvcs_sockets,network_information,users_information,software_information,interesting_files"
WAIT=""
PASSWORD=""
NOCOLOR=""
DEBUG=""
...
${NC}This tool enum and search possible misconfigurations$DG (known vulns, user, processes and file permissions, special file permissions, readable/writable files, bruteforce other users(top1000pwds), passwords...)$NC inside the host and highlight possible misconfigurations with colors.
      ...
      ${YELLOW}-o${BLUE} Only execute selected checks (system_information,container,available_software,procs_crons_timers_srvcs_sockets,network_information,users_information,software_information,interesting_files). Select a comma separated list.
...
USEFUL_SOFTWARE="docker lxc rkt kubectl podman runc nmap aws nc ncat netcat nc.traditional wget curl ping gcc g++ make gdb base64 socat python python2 python3 python2.7 python2.6 python3.6 python3.7 perl php ruby xterm doas sudo fetch ctr authbind"
...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"postfix\" -o -name \"bind\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"system.d\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"system-connections\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"pam.d\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"postfix\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"postfix\" -o -name \"bind\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"postfix\" -o -name \"bind\" -o -name \"couchdb\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \"environments\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"sentry\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"seeddms*\" -o -name \".svn\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*knockd*\" -o -name \"exports\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"ssh*config\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"sess_*\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"sess_*\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"agent*\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.timer\" -o -name \"*.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"sess_*\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"agent*\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"ssh*config\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"*.keystore\" -o -name \"db.php\" -o -name \".vault-token\" -o -name \"mongod*.conf\" -o -name \"id_rsa*\" -o -name \"sites.ini\" -o -name \"racoon.conf\" -o -name \"ftp.config\" -o -name \"Dockerfile\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"pg_hba.conf\" -o -name \".erlang.cookie\" -o -name \"gitlab.rm\" -o -name \"*.socket\" -o -name \"*vnc*.c*nf*\" -o -name \"access.log\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"settings.php\" -o -name \"secrets.yml\" -o -name \"*.cer\" -o -name \"httpd.conf\" -o -name \"hosts.equiv\" -o -name \"backups\" -o -name \"*.csr\" -o -name \"*credential*\" -o -name \"storage.php\" -o -name \"rsyncd.conf\" -o -name \"*.pgp\" -o -name \"anaconda-ks.cfg\" -o -name \"*.der\" -o -name \"sssd.conf\" -o -name \"SecEvent.Evt\" -o -name \".htpasswd\" -o -name \"mariadb.cnf\" -o -name \"*.ftpconfig\" -o -name \"*.sqlite3\" -o -name \"pagefile.sys\" -o -name \"cloud.cfg\" -o -name \"ipsec.conf\" -o -name \"authorized_keys\" -o -name \".gitconfig\" -o -name \".rhosts\" -o -name \"winscp.ini\" -o -name \"redis.conf\" -o -name \"accessTokens.json\" -o -name \"*config*.php\" -o -name \".git\" -o -name \"KeePass.enforced*\" -o -name \"cesi.conf\" -o -name \"system.sav\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"sess_*\" -o -name \".env\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"datasources.xml\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"access_tokens.db\" -o -name \"KeePass.config*\" -o -name \"wcx_ftp.ini\" -o -name \"legacy_credentials.db\" -o -name \"*_history*\" -o -name \"*.rdg\" -o -name \"server.xml\" -o -name \"pgsql.conf\" -o -name \"wp-config.php\" -o -name \".k5login\" -o -name \"TokenCache.dat\" -o -name \"index.dat\" -o -name \"gitlab.yml\" -o -name \"autologin.conf\" -o -name \"autologin\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"psk.txt\" -o -name \".lesshst\" -o -name \"elasticsearch.y*ml\" -o -name \"protecteduserkey.bin\" -o -name \"pgadmin*.db\" -o -name \"software\" -o -name \"*.service\" -o -name \"kibana.y*ml\" -o -name \"SAM\" -o -name \"sysprep.xml\" -o -name \"docker.socket\" -o -name \"my.cnf\" -o -name \"error.log\" -o -name \"supervisord.conf\" -o -name \".github\" -o -name \"*password*\" -o -name \"config.php\" -o -name \"secrets.ldb\" -o -name \"*.psk\" -o -name \"web*.config\" -o -name \"*.pem\" -o -name \"recentservers.xml\" -o -name \"sentry.conf.py\" -o -name \"filezilla.xml\" -o -name \".pypirc\" -o -name \"kcpassword\" -o -name \"ntuser.dat\" -o -name \"krb5.conf\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"influxdb.conf\" -o -name \"docker-compose.yml\" -o -name \"*.gnupg\" -o -name \"sitemanager.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"ffftp.ini\" -o -name \"groups.xml\" -o -name \".ldaprc\" -o -name \"passwd\" -o -name \"ddclient.conf\" -o -name \"mosquitto.conf\" -o -name \"printers.xml\" -o -name \"rsyncd.secrets\" -o -name \"*.p12\" -o -name \"credentials\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \".plan\" -o -name \"Ntds.dit\" -o -name \"setupinfo\" -o -name \"https-xampp.conf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"*.crt\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"zabbix_server.conf\" -o -name \"tomcat-users.xml\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \"scclient.exe\" -o -name \"*vnc*.xml\" -o -name \"NetSetup.log\" -o -name \"known_hosts\" -o -name \"scheduledtasks.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"*.jks\" -o -name \"database.php\" -o -name \"authorized_hosts\" -o -name \".recently-used.xbel\" -o -name \"bash.exe\" -o -name \"*.keyring\" -o -name \"creds*\" -o -name \"*.key\" -o -name \"snmpd.conf\" -o -name \"software.sav\" -o -name \".wgetrc\" -o -name \"drives.xml\" -o -name \"unattend.xml\" -o -name \"*.viminfo\" -o -name \"unattend.inf\" -o -name \"hostapd.conf\" -o -name \"kadm5.acl\" -o -name \".secrets.mkey\" -o -name \"https.conf\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"php.ini\" -o -name \".msmtprc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"unattended.xml\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"*vnc*.txt\" -o -name \"backup\" -o -name \"AzureRMContext.json\" -o -name \"*.swp\" -o -name \"KeePass.ini\" -o -name \"my.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \"zabbix_agentd.conf\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/system|^/run|^/bin|^/etc|^/opt|^/tmp|^/var|^/snap|^/lib32|^/private|^/sys|^/mnt|^/media|^/usr|^/cdrom|^/srv|^/systemd|^$GREPHOMESEARCH|^/applications|^/.cache|^/lib|^/lib64|^/sbin" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/system|^/run|^/bin|^/etc|^/opt|^/tmp|^/var|^/snap|^/lib32|^/private|^/sys|^/mnt|^/media|^/usr|^/cdrom|^/srv|^/systemd|^$GREPHOMESEARCH|^/applications|^/.cache|^/lib|^/lib64|^/sbin" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/system|^/run|^/bin|^/etc|^/opt|^/tmp|^/var|^/snap|^/lib32|^/private|^/sys|^/mnt|^/media|^/usr|^/cdrom|^/srv|^/systemd|^$GREPHOMESEARCH|^/applications|^/.cache|^/lib|^/lib64|^/sbin" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/private|^/mnt|^/tmp|^/var" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/default/settings.php' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E 'moodle/config.php' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/usr|^$GREPHOMESEARCH" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '/lib' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E 'README.gnupg' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PRE_SHARED_KEYS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.psk$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/usr|^/var|^/etc" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_RUN\n$FIND_ETC\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_CACHE\n$FIND_SYSTEM\n$FIND_LIB32\n$FIND_TMP\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_MNT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_USR\n$FIND_VAR\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/private|^/tmp|^$GREPHOMESEARCH|^/applications|^/.cache|^/cdrom|^/bin|^/srv|^/sbin|^/mnt|^/etc|^/opt|^/media|^/usr|^/var|^/snap" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
...
if [ "$PSTORAGE_MARIADB" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_POSTGRESQL" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_MONGO" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_APACHE" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Apache Files (limit 70)"
    ...
    if ! [ "`echo \"$PSTORAGE_APACHE\" | grep -E \"sites-enabled$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "sites-enabled"; fi; fi; printf "%s" "$PSTORAGE_APACHE" | grep -E "sites-enabled$" | while read f; do ls -ld "$f" | sed -${E} "s,sites-enabled$,${SED_RED},"; for ff in $(find "$f" -name "*"); do ls -ld "$ff" | sed -${E} "s,.*,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -E "AuthType|AuthName|AuthUserFile|ServerName|ServerAlias" | grep -Ev "#" | sed -${E} "s,AuthType|AuthName|AuthUserFile|ServerName|ServerAlias,${SED_RED},g"; done; echo "";done; echo "";
...
if [ "$PSTORAGE_TOMCAT" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_FASTCGI" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_HTTP_CONF" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_HTPASSWD" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PHP_SESSIONS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_WORDPRESS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_DRUPAL" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_MOODLE" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_SUPERVISORD" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_RSYNC" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_HOSTAPD" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_WIFI_CONNECTIONS" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Wifi Connections Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_WIFI_CONNECTIONS\" | grep -E \"system-connections$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "system-connections"; fi; fi; printf "%s" "$PSTORAGE_WIFI_CONNECTIONS" | grep -E "system-connections$" | while read f; do ls -ld "$f" | sed -${E} "s,system-connections$,${SED_RED},"; for ff in $(find "$f" -name "*"); do ls -ld "$ff" | sed -${E} "s,.*,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -E "psk.*" | sed -${E} "s,psk.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_ANACONDA_KS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_VNC" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing VNC Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_VNC\" | grep -E \"\.vnc$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found ".vnc"; fi; fi; printf "%s" "$PSTORAGE_VNC" | grep -E "\.vnc$" | while read f; do ls -ld "$f" | sed -${E} "s,\.vnc$,${SED_RED},"; for ff in $(find "$f" -name "passwd"); do ls -ld "$ff" | sed -${E} "s,passwd,${SED_RED},"; done; echo "";done; echo "";
...
if [ "$PSTORAGE_LDAP" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Ldap Files (limit 70)"
    echo "The password hash is from the {SSHA} to 'structural'"
    if ! [ "`echo \"$PSTORAGE_LDAP\" | grep -E \"ldap$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "ldap"; fi; fi; printf "%s" "$PSTORAGE_LDAP" | grep -E "ldap$" | while read f; do ls -ld "$f" | sed -${E} "s,ldap$,${SED_RED},"; for ff in $(find "$f" -name "*.bdb"); do ls -ld "$ff" | sed -${E} "s,.bdb,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -E -i -a -o "description.*" | sort | uniq | sed -${E} "s,administrator|password|ADMINISTRATOR|PASSWORD|Password|Administrator,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_OPENVPN" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PAM_AUTH" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing PAM Auth Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_PAM_AUTH\" | grep -E \"pam\.d$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "pam.d"; fi; fi; printf "%s" "$PSTORAGE_PAM_AUTH" | grep -E "pam\.d$" | while read f; do ls -ld "$f" | sed -${E} "s,pam\.d$,${SED_RED},"; for ff in $(find "$f" -name "sshd"); do ls -ld "$ff" | sed -${E} "s,sshd,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -E -i "auth" | grep -Ev "^#|^@" | sed -${E} "s,.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi
...
if [ "$PSTORAGE_NFS_EXPORTS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_KNOCKD" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_KIBANA" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_ELASTICSEARCH" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_COUCHDB" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing CouchDB Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_COUCHDB\" | grep -E \"couchdb$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "couchdb"; fi; fi; printf "%s" "$PSTORAGE_COUCHDB" | grep -E "couchdb$" | while read f; do ls -ld "$f" | sed -${E} "s,couchdb$,${SED_RED},"; for ff in $(find "$f" -name "local.ini"); do ls -ld "$ff" | sed -${E} "s,local.ini,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -Ev "^;" | sed -${E} "s,admin.*|password.*|cert_file.*|key_file.*|hashed.*|pbkdf2.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_REDIS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_MOSQUITTO" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_NEO4J" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Neo4j Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_NEO4J\" | grep -E \"neo4j$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "neo4j"; fi; fi; printf "%s" "$PSTORAGE_NEO4J" | grep -E "neo4j$" | while read f; do ls -ld "$f" | sed -${E} "s,neo4j$,${SED_RED},"; for ff in $(find "$f" -name "auth"); do ls -ld "$ff" | sed -${E} "s,auth,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | sed -${E} "s,.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_CLOUD_CREDENTIALS" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Cloud Credentials Files (limit 70)"
    ...
    if ! [ "`echo \"$PSTORAGE_CLOUD_CREDENTIALS\" | grep -E \"\.bluemix$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found ".bluemix"; fi; fi; printf "%s" "$PSTORAGE_CLOUD_CREDENTIALS" | grep -E "\.bluemix$" | while read f; do ls -ld "$f" | sed -${E} "s,\.bluemix$,${SED_RED},"; for ff in $(find "$f" -name "config.json"); do ls -ld "$ff" | sed -${E} "s,config.json,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | sed -${E} "s,.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_CLOUD_INIT" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_CLOUDFLARE" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_ERLANG" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_GMV_AUTH" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_IPSEC" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_IRSSI" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing IRSSI Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_IRSSI\" | grep -E \"\.irssi$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found ".irssi"; fi; fi; printf "%s" "$PSTORAGE_IRSSI" | grep -E "\.irssi$" | while read f; do ls -ld "$f" | sed -${E} "s,\.irssi$,${SED_RED},"; for ff in $(find "$f" -name "config"); do ls -ld "$ff" | sed -${E} "s,config,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | sed -${E} "s,password.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_KEYRING" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_FILEZILLA" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Filezilla Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_FILEZILLA\" | grep -E \"filezilla$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "filezilla"; fi; fi; printf "%s" "$PSTORAGE_FILEZILLA" | grep -E "filezilla$" | while read f; do ls -ld "$f" | sed -${E} "s,filezilla$,${SED_RED},"; for ff in $(find "$f" -name "sitemanager.xml"); do ls -ld "$ff" | sed -${E} "s,sitemanager.xml,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -Ev "^;" | sed -${E} "s,Host.*|Port.*|Protocol.*|User.*|Pass.*,${SED_RED},g"; done; echo "";done; echo "";
...
if [ "$PSTORAGE_BACKUP_MANAGER" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_GITHUB" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PGP_GPG" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_CACHE_VI" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_FIREFOX" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_CHROME" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_AUTOLOGIN" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PYPIRC" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_POSTFIX" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_LDAPRC" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_MSMTPRC" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_KEEPASS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_RACOON" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_OPERA" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_SAFARI" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_INFLUXDB" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_ZABBIX" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Zabbix Files (limit 70)"
    ...
    if ! [ "`echo \"$PSTORAGE_ZABBIX\" | grep -E \"zabbix$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "zabbix"; fi; fi; printf "%s" "$PSTORAGE_ZABBIX" | grep -E "zabbix$" | while read f; do ls -ld "$f" | sed -${E} "s,zabbix$,${SED_RED},"; for ff in $(find "$f" -name "*.psk"); do ls -ld "$ff" | sed -${E} "s,.psk,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | sed -${E} "s,.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_PRE_SHARED_KEYS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PASS_STORE_DIRECTORIES" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_BIND" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Bind Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_BIND\" | grep -E \"bind$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "bind"; fi; fi; printf "%s" "$PSTORAGE_BIND" | grep -E "bind$" | while read f; do ls -ld "$f" | sed -${E} "s,bind$,${SED_RED},"; for ff in $(find "$f" -name "*"); do ls -ld "$ff" | sed -${E} "s,.*,${SED_RED},"; done; echo "";for ff in $(find "$f" -name "*.key"); do ls -ld "$ff" | sed -${E} "s,.key,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -Ev "^#" | sed -${E} "s,.*,${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_SEEDDMS" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing SeedDMS Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_SEEDDMS\" | grep -E \"seeddms.*$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "seeddms*"; fi; fi; printf "%s" "$PSTORAGE_SEEDDMS" | grep -E "seeddms.*$" | while read f; do ls -ld "$f" | sed -${E} "s,seeddms.*$,${SED_RED},"; for ff in $(find "$f" -name "settings.xml"); do ls -ld "$ff" | sed -${E} "s,settings.xml,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -E "=" | sed -${E} "s,[pP][aA][sS][sS],${SED_RED},g"; done; echo "";done; echo "";
elif [ "$VERBOSE" ]; then echo_not_found
fi


if [ "$PSTORAGE_DDCLIENT" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_SENTRY" ] || [ "$VERBOSE" ]; then
  print_2title "Analyzing Sentry Files (limit 70)"
    if ! [ "`echo \"$PSTORAGE_SENTRY\" | grep -E \"sentry$\"`" ]; then if [ "$DEBUG" ]; then echo_not_found "sentry"; fi; fi; printf "%s" "$PSTORAGE_SENTRY" | grep -E "sentry$" | while read f; do ls -ld "$f" | sed -${E} "s,sentry$,${SED_RED},"; for ff in $(find "$f" -name "config.yml"); do ls -ld "$ff" | sed -${E} "s,config.yml,${SED_RED},"; cat "$ff" 2>/dev/null | grep -IEv "^$" | grep -Ev "^#" | sed -${E} "s,*key*,${SED_RED},g"; done; echo "";done; echo "";
...
if [ "$PSTORAGE_STRAPI" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_PASSBOLT" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_JETTY" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_INTERESTING_LOGS" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_WINDOWS_FILES" ] || [ "$VERBOSE" ]; then
...
if [ "$PSTORAGE_OTHER_INTERESTING_FILES" ] || [ "$VERBOSE" ]; then
