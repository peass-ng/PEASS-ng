...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"system.d\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"seeddms*\" -o -name \"mysql\" -o -name \"sites-enabled\" -o -name \"ldap\" -o -name \".irssi\" -o -name \".svn\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \".bluemix\" -o -name \"couchdb\" -o -name \"cacti\" -o -name \"logstash\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"bind\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"agent*\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.timer\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_USR=`eval_bckgrd "find /usr -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"ssh*config\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"cloud.cfg\" -o -name \"my.cnf\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"unattend.xml\" -o -name \"autologin.conf\" -o -name \"kcpassword\" -o -name \"web*.config\" -o -name \"autologin\" -o -name \".git\" -o -name \"groups.xml\" -o -name \"*.crt\" -o -name \"azureProfile.json\" -o -name \".vault-token\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"drives.xml\" -o -name \"gvm-tools.conf\" -o -name \"sysprep.inf\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"fastcgi_params\" -o -name \".rhosts\" -o -name \"*.swp\" -o -name \"*.csr\" -o -name \"accessTokens.json\" -o -name \"sitemanager.xml\" -o -name \"db.php\" -o -name \"storage.php\" -o -name \"pg_hba.conf\" -o -name \"gitlab.yml\" -o -name \"*.gnupg\" -o -name \"hosts.equiv\" -o -name \"system.sav\" -o -name \"000-default.conf\" -o -name \"unattend.txt\" -o -name \"*.key\" -o -name \"mongod*.conf\" -o -name \"httpd.conf\" -o -name \"KeePass.config*\" -o -name \"security.sav\" -o -name \"KeePass.enforced*\" -o -name \"setupinfo.bak\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"elasticsearch.y*ml\" -o -name \"config.php\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.db\" -o -name \"ws_ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*.pgp\" -o -name \"wp-config.php\" -o -name \"authorized_hosts\" -o -name \"kibana.y*ml\" -o -name \"*password*\" -o -name \"ffftp.ini\" -o -name \"default.sav\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.xml\" -o -name \"ntuser.dat\" -o -name \".lesshst\" -o -name \"id_dsa*\" -o -name \"ddclient.conf\" -o -name \"https-xampp.conf\" -o -name \"AppEvent.Evt\" -o -name \"server.xml\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \"ftp.ini\" -o -name \"TokenCache.dat\" -o -name \"recentservers.xml\" -o -name \"sites.ini\" -o -name \"appcmd.exe\" -o -name \"supervisord.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"Dockerfile\" -o -name \".ldaprc\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"software.sav\" -o -name \"*.timer\" -o -name \"krb5.keytab\" -o -name \"database.php\" -o -name \".git-credentials\" -o -name \"winscp.ini\" -o -name \"ipsec.conf\" -o -name \"*.viminfo\" -o -name \"docker-compose.yml\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"docker.socket\" -o -name \"access_tokens.json\" -o -name \"racoon.conf\" -o -name \"SAM\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"*.service\" -o -name \"redis.conf\" -o -name \"secrets.yml\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.ftpconfig\" -o -name \"wsl.exe\" -o -name \"*.p12\" -o -name \"kadm5.acl\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"NetSetup.log\" -o -name \"unattend.inf\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \".*_history.*\" -o -name \"access.log\" -o -name \"docker.sock\" -o -name \".plan\" -o -name \"error.log\" -o -name \"*.pfx\" -o -name \"pagefile.sys\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"settings.php\" -o -name \"credentials\" -o -name \"*.keystore\" -o -name \"*.sqlite\" -o -name \"mosquitto.conf\" -o -name \"gitlab.rm\" -o -name \"anaconda-ks.cfg\" -o -name \"*.socket\" -o -name \".msmtprc\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"psk.txt\" -o -name \"AzureRMContext.json\" -o -name \"ipsec.secrets\" -o -name \"tomcat-users.xml\" -o -name \"rsyncd.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \"postgresql.conf\" -o -name \"KeePass.ini\" -o -name \"protecteduserkey.bin\" -o -name \"php.ini\" -o -name \".bashrc\" -o -name \".github\" -o -name \"printers.xml\" -o -name \"wcx_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"debian.cnf\" -o -name \"krb5.conf\" -o -name \".erlang.cookie\" -o -name \"datasources.xml\" -o -name \"backup\" -o -name \"authorized_keys\" -o -name \"pgsql.conf\" -o -name \".env\" -o -name \"known_hosts\" -o -name \"*.gpg\" -o -name \"snmpd.conf\" -o -name \".htpasswd\" -o -name \"*.cer\" -o -name \"backups\" -o -name \"SYSTEM\" -o -name \"Ntds.dit\" -o -name \"cesi.conf\" -o -name \"*.sqlite3\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" -o -name \"bash.exe\" -o -name \"iis6.log\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"setupinfo\" -o -name \"passwd\" -o -name \"*.keyring\" -o -name \"*.kdbx\" -o -name \"*.ovpn\" -o -name \"*.jks\" -o -name \"*.der\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/sys|^/private|^/applications|^/media|^/bin|^/var|^/usr|^/srv|^$GREPHOMESEARCH|^/lib64|^/mnt|^/tmp|^/system|^/sbin|^/lib|^/run|^/lib32|^/snap|^/opt|^/cdrom|^/.cache|^/systemd|^/etc" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/sys|^/private|^/applications|^/media|^/bin|^/var|^/usr|^/srv|^$GREPHOMESEARCH|^/lib64|^/mnt|^/tmp|^/system|^/sbin|^/lib|^/run|^/lib32|^/snap|^/opt|^/cdrom|^/.cache|^/systemd|^/etc" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/sys|^/private|^/applications|^/media|^/bin|^/var|^/usr|^/srv|^$GREPHOMESEARCH|^/lib64|^/mnt|^/tmp|^/system|^/sbin|^/lib|^/run|^/lib32|^/snap|^/opt|^/cdrom|^/.cache|^/systemd|^/etc" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH\n$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH\n$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/private|^/mnt|^/tmp" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E '/default/settings.php' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E 'moodle/config.php' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH\n$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/private|^/tmp" | grep -E "agent.*$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_KERBEROS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH\n$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH\n$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E '/lib' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E 'README.gnupg' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SNAP\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_SNAP\n$FIND_SRV\n$FIND_PRIVATE\n$FIND_USR\n$FIND_BIN\n$FIND_MEDIA\n$FIND_OPT\n$FIND_RUN\n$FIND_SBIN\n$FIND_SYS\n$FIND_MNT\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_CDROM\n$FIND_ETC\n$FIND_CACHE\n$FIND_LIB64\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_LIB\n$FIND_HOMESEARCH"  | grep -E "^/bin|^/var|^/usr|^/etc|^/private|^/sbin|^/snap|^/mnt|^/srv|^$GREPHOMESEARCH|^/opt|^/applications|^/cdrom|^/media|^/.cache|^/tmp" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
