...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"sess_*\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"agent*\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"sess_*\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_USR=`eval_bckgrd "find /usr -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"ssh*config\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \".k5login\" -o -name \"redis.conf\" -o -name \"wcx_ftp.ini\" -o -name \"mosquitto.conf\" -o -name \"id_dsa*\" -o -name \"docker-compose.yml\" -o -name \"web*.config\" -o -name \"KeePass.enforced*\" -o -name \"*.timer\" -o -name \".erlang.cookie\" -o -name \"gitlab.yml\" -o -name \"php.ini\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"*password*\" -o -name \".git-credentials\" -o -name \"*.sqlite3\" -o -name \"my.cnf\" -o -name \"system.sav\" -o -name \"wp-config.php\" -o -name \".env\" -o -name \"sysprep.xml\" -o -name \"SYSTEM\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"setupinfo\" -o -name \"printers.xml\" -o -name \"*.crt\" -o -name \"*.keystore\" -o -name \"https-xampp.conf\" -o -name \".ldaprc\" -o -name \"software.sav\" -o -name \"my.ini\" -o -name \"httpd.conf\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"unattended.xml\" -o -name \"drives.xml\" -o -name \"software\" -o -name \"pagefile.sys\" -o -name \"*.key\" -o -name \"authorized_keys\" -o -name \"unattend.inf\" -o -name \"*.db\" -o -name \"unattend.xml\" -o -name \"accessTokens.json\" -o -name \"*.gpg\" -o -name \"credentials.db\" -o -name \"*vnc*.xml\" -o -name \"krb5.keytab\" -o -name \"db.php\" -o -name \"supervisord.conf\" -o -name \"config.php\" -o -name \"*vnc*.ini\" -o -name \"*.der\" -o -name \"mongod*.conf\" -o -name \"protecteduserkey.bin\" -o -name \".lesshst\" -o -name \"backups\" -o -name \"database.php\" -o -name \"hosts.equiv\" -o -name \"backup\" -o -name \"*.swp\" -o -name \"index.dat\" -o -name \"rsyncd.secrets\" -o -name \"storage.php\" -o -name \".vault-token\" -o -name \"FreeSSHDservice.ini\" -o -name \"sitemanager.xml\" -o -name \"*.keyring\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \".github\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"authorized_hosts\" -o -name \"*.gnupg\" -o -name \"ws_ftp.ini\" -o -name \"secrets.yml\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"filezilla.xml\" -o -name \".recently-used.xbel\" -o -name \"groups.xml\" -o -name \"AppEvent.Evt\" -o -name \".*_history.*\" -o -name \"Ntds.dit\" -o -name \"creds*\" -o -name \"recentservers.xml\" -o -name \"docker.socket\" -o -name \"appcmd.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"kibana.y*ml\" -o -name \"access.log\" -o -name \"iis6.log\" -o -name \"*.pem\" -o -name \"ntuser.dat\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"000-default.conf\" -o -name \"credentials\" -o -name \"azureProfile.json\" -o -name \"elasticsearch.y*ml\" -o -name \"*.ovpn\" -o -name \"legacy_credentials.db\" -o -name \"datasources.xml\" -o -name \"gvm-tools.conf\" -o -name \".google_authenticator\" -o -name \"*vnc*.c*nf*\" -o -name \"TokenCache.dat\" -o -name \".bashrc\" -o -name \"security.sav\" -o -name \"*.pfx\" -o -name \"passwd\" -o -name \".rhosts\" -o -name \"wsl.exe\" -o -name \"vault-ssh-helper.hcl\" -o -name \"NetSetup.log\" -o -name \"*.kdbx\" -o -name \"sites.ini\" -o -name \"bash.exe\" -o -name \"pgadmin*.db\" -o -name \"tomcat-users.xml\" -o -name \"*.p12\" -o -name \"sess_*\" -o -name \"AzureRMContext.json\" -o -name \"*.csr\" -o -name \"*.pgp\" -o -name \"access_tokens.json\" -o -name \"docker.sock\" -o -name \".profile\" -o -name \"*vnc*.txt\" -o -name \"snmpd.conf\" -o -name \"*.cer\" -o -name \"ftp.ini\" -o -name \"RDCMan.settings\" -o -name \"*config*.php\" -o -name \"setupinfo.bak\" -o -name \"ftp.config\" -o -name \"scclient.exe\" -o -name \"rsyncd.conf\" -o -name \"id_rsa*\" -o -name \"autologin\" -o -name \"debian.cnf\" -o -name \"ConsoleHost_history.txt\" -o -name \"*.ftpconfig\" -o -name \"KeePass.config*\" -o -name \"ffftp.ini\" -o -name \"https.conf\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"settings.php\" -o -name \"default.sav\" -o -name \"fastcgi_params\" -o -name \".git\" -o -name \"cesi.conf\" -o -name \"KeePass.ini\" -o -name \"kadm5.acl\" -o -name \"*.jks\" -o -name \"gitlab.rm\" -o -name \"*.viminfo\" -o -name \"scheduledtasks.xml\" -o -name \"kcpassword\" -o -name \"winscp.ini\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"server.xml\" -o -name \".htpasswd\" -o -name \"ddclient.conf\" -o -name \"*.rdg\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"*.socket\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^$GREPHOMESEARCH|^/system|^/lib|^/systemd|^/etc|^/applications|^/bin|^/lib32|^/run|^/usr|^/.cache|^/media|^/opt|^/lib64|^/sys|^/tmp|^/sbin|^/cdrom|^/srv|^/mnt|^/var|^/snap|^/private" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^$GREPHOMESEARCH|^/system|^/lib|^/systemd|^/etc|^/applications|^/bin|^/lib32|^/run|^/usr|^/.cache|^/media|^/opt|^/lib64|^/sys|^/tmp|^/sbin|^/cdrom|^/srv|^/mnt|^/var|^/snap|^/private" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^$GREPHOMESEARCH|^/system|^/lib|^/systemd|^/etc|^/applications|^/bin|^/lib32|^/run|^/usr|^/.cache|^/media|^/opt|^/lib64|^/sys|^/tmp|^/sbin|^/cdrom|^/srv|^/mnt|^/var|^/snap|^/private" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/tmp|^/var|^/mnt|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E '/default/settings.php' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E 'moodle/config.php' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "racoon$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_KERBEROS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E '/lib' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E 'README.gnupg' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_PRIVATE\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CDROM\n$FIND_DIR_MEDIA\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_BIN\n$FIND_DIR_USR\n$FIND_DIR_SRV\n$FIND_DIR_SBIN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_BIN\n$FIND_LIB64\n$FIND_PRIVATE\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_HOMESEARCH\n$FIND_TMP\n$FIND_CDROM\n$FIND_SRV\n$FIND_SBIN\n$FIND_LIB\n$FIND_SNAP\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_MEDIA\n$FIND_SYS\n$FIND_OPT\n$FIND_RUN"  | grep -E "^/bin|^/cdrom|^$GREPHOMESEARCH|^/usr|^/.cache|^/srv|^/applications|^/media|^/opt|^/mnt|^/tmp|^/var|^/etc|^/snap|^/private|^/sbin" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
