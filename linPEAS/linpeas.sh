...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"system.d\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"ldap\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \".irssi\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".vnc\" -o -name \"cacti\" -o -name \"sites-enabled\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*knockd*\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"ssh*config\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"sess_*\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"sess_*\" -o -name \"hostapd.conf\" -o -name \"agent*\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"drives.xml\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.service\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_USR=`eval_bckgrd "find /usr -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"ssh*config\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"system.sav\" -o -name \"docker-compose.yml\" -o -name \".k5login\" -o -name \"docker.sock\" -o -name \"error.log\" -o -name \"printers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".rhosts\" -o -name \"psk.txt\" -o -name \"web*.config\" -o -name \"Dockerfile\" -o -name \"*.gnupg\" -o -name \"gitlab.yml\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"krb5.conf\" -o -name \"settings.php\" -o -name \"authorized_hosts\" -o -name \"ntuser.dat\" -o -name \"unattend.inf\" -o -name \".profile\" -o -name \"*.csr\" -o -name \".git\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"SecEvent.Evt\" -o -name \"*.key\" -o -name \"ipsec.secrets\" -o -name \"security.sav\" -o -name \"*credential*\" -o -name \"pgadmin*.db\" -o -name \"db.php\" -o -name \"kibana.y*ml\" -o -name \"sess_*\" -o -name \"hostapd.conf\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \".gitconfig\" -o -name \"backups\" -o -name \"rsyncd.secrets\" -o -name \".ldaprc\" -o -name \"known_hosts\" -o -name \"*config*.php\" -o -name \"*.socket\" -o -name \".pypirc\" -o -name \"httpd.conf\" -o -name \"*.keystore\" -o -name \".msmtprc\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"*vnc*.ini\" -o -name \"access.log\" -o -name \"snmpd.conf\" -o -name \"*.keyring\" -o -name \"my.ini\" -o -name \".git-credentials\" -o -name \"*.sqlite\" -o -name \"anaconda-ks.cfg\" -o -name \"id_rsa*\" -o -name \"*.timer\" -o -name \"kcpassword\" -o -name \"pgsql.conf\" -o -name \".lesshst\" -o -name \"KeePass.ini\" -o -name \"recentservers.xml\" -o -name \"azureProfile.json\" -o -name \".erlang.cookie\" -o -name \"*.pem\" -o -name \"passwd\" -o -name \"SYSTEM\" -o -name \"000-default.conf\" -o -name \"*vnc*.c*nf*\" -o -name \"bash.exe\" -o -name \"ftp.ini\" -o -name \"*.cer\" -o -name \"iis6.log\" -o -name \"software.sav\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \"datasources.xml\" -o -name \".github\" -o -name \"*.der\" -o -name \"appcmd.exe\" -o -name \".plan\" -o -name \"setupinfo\" -o -name \".recently-used.xbel\" -o -name \"sysprep.xml\" -o -name \"pagefile.sys\" -o -name \"*.service\" -o -name \"rsyncd.conf\" -o -name \"tomcat-users.xml\" -o -name \"*.sqlite3\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"credentials\" -o -name \"sysprep.inf\" -o -name \".vault-token\" -o -name \"wsl.exe\" -o -name \"database.php\" -o -name \"accessTokens.json\" -o -name \"id_dsa*\" -o -name \"cloud.cfg\" -o -name \"*.ftpconfig\" -o -name \"vault-ssh-helper.hcl\" -o -name \"racoon.conf\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"ConsoleHost_history.txt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.jks\" -o -name \"gvm-tools.conf\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"authorized_keys\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"krb5.keytab\" -o -name \"default.sav\" -o -name \"autologin.conf\" -o -name \"*.kdbx\" -o -name \"*.pgp\" -o -name \"ffftp.ini\" -o -name \"ddclient.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.p12\" -o -name \"cesi.conf\" -o -name \"*.db\" -o -name \"ipsec.conf\" -o -name \"groups.xml\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"software\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \".*_history.*\" -o -name \"fastcgi_params\" -o -name \"credentials.db\" -o -name \"https.conf\" -o -name \"protecteduserkey.bin\" -o -name \"autologin\" -o -name \"pg_hba.conf\" -o -name \"postgresql.conf\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"*.crt\" -o -name \"gitlab.rm\" -o -name \"ftp.config\" -o -name \".bashrc\" -o -name \"*.pfx\" -o -name \"*.ovpn\" -o -name \"wcx_ftp.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"debian.cnf\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"redis.conf\" -o -name \"sites.ini\" -o -name \"index.dat\" -o -name \"supervisord.conf\" -o -name \"*.gpg\" -o -name \"hosts.equiv\" -o -name \"AppEvent.Evt\" -o -name \"kadm5.acl\" -o -name \"server.xml\" -o -name \"scclient.exe\" -o -name \"*vnc*.txt\" -o -name \"creds*\" -o -name \"*.rdg\" -o -name \"my.cnf\" -o -name \"filezilla.xml\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"setupinfo.bak\" -o -name \"*.viminfo\" -o -name \"sitemanager.xml\" -o -name \"wp-config.php\" -o -name \"AzureRMContext.json\" -o -name \"unattend.txt\" -o -name \"unattended.xml\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/sys|^/lib32|^$GREPHOMESEARCH|^/snap|^/bin|^/srv|^/systemd|^/lib|^/sbin|^/mnt|^/cdrom|^/var|^/usr|^/applications|^/system|^/private|^/etc|^/.cache|^/lib64|^/media|^/tmp|^/run|^/opt" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/sys|^/lib32|^$GREPHOMESEARCH|^/snap|^/bin|^/srv|^/systemd|^/lib|^/sbin|^/mnt|^/cdrom|^/var|^/usr|^/applications|^/system|^/private|^/etc|^/.cache|^/lib64|^/media|^/tmp|^/run|^/opt" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/sys|^/lib32|^$GREPHOMESEARCH|^/snap|^/bin|^/srv|^/systemd|^/lib|^/sbin|^/mnt|^/cdrom|^/var|^/usr|^/applications|^/system|^/private|^/etc|^/.cache|^/lib64|^/media|^/tmp|^/run|^/opt" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_MYSQL=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E '/default/settings.php' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E 'moodle/config.php' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_KERBEROS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E '/lib' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E 'README.gnupg' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_TMP\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_ETC\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_USR\n$FIND_CDROM\n$FIND_SYS\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_VAR\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_OPT\n$FIND_SRV\n$FIND_MEDIA\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_RUN\n$FIND_LIB32\n$FIND_TMP\n$FIND_BIN"  | grep -E "^/.cache|^/mnt|^/cdrom|^/var|^/bin|^/usr|^/etc|^/applications|^/srv|^/media|^/tmp|^$GREPHOMESEARCH|^/opt|^/private|^/sbin|^/snap" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
