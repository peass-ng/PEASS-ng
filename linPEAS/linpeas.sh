...
INT_HIDDEN_FILES=".bashrc|.bluemix|.cer|.cloudflared|.crt|.csr|.db|.der|.env|.erlang.cookie|.ftpconfig|.git|.git-credentials|.gitconfig|.github|.gnupg|.google_authenticator|.gpg|.htpasswd|.irssi|.jks|.k5login|.kdbx|.key|.keyring|.keystore|.ldaprc|.lesshst|.mozilla|.msmtprc|.ovpn|.p12|.password-store|.pem|.pfx|.pgp|.plan|.profile|.pypirc|.rdg|.recently-used.xbel|.rhosts|.secrets.mkey|.service|.socket|.sqlite|.sqlite3|.sudo_as_admin_successful|.svn|.swp|.timer|.vault-token|.viminfo|.vnc|.wgetrc"
...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"bind\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"pam.d\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"system-connections\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"system.d\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"bind\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \".vnc\" -o -name \"environments\" -o -name \"roundcube\" -o -name \"bind\" -o -name \"ldap\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sites-enabled\" -o -name \".password-store\" -o -name \"seeddms*\" -o -name \"zabbix\" -o -name \"keyrings\" -o -name \"sentry\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"neo4j\" -o -name \"couchdb\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".irssi\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*knockd*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"exports\" -o -name \"docker.sock\" -o -name \"creds*\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"ssh*config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"sess_*\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"agent*\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"sess_*\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"agent*\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"sess_*\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"ssh*config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"ConsoleHost_history.txt\" -o -name \"cloud.cfg\" -o -name \"autologin\" -o -name \"tomcat-users.xml\" -o -name \"krb5.keytab\" -o -name \".plan\" -o -name \"winscp.ini\" -o -name \"*.keyring\" -o -name \"sentry.conf.py\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"secrets.yml\" -o -name \".google_authenticator\" -o -name \"krb5.conf\" -o -name \"ftp.config\" -o -name \".pypirc\" -o -name \"debian.cnf\" -o -name \"Dockerfile\" -o -name \"TokenCache.dat\" -o -name \"passbolt.php\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"secrets.ldb\" -o -name \"unattend.inf\" -o -name \"access_tokens.db\" -o -name \"groups.xml\" -o -name \"Ntds.dit\" -o -name \"jetty-realm.properties\" -o -name \"scheduledtasks.xml\" -o -name \"https.conf\" -o -name \"accessTokens.json\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"iis6.log\" -o -name \".env\" -o -name \"software\" -o -name \"elasticsearch.y*ml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.kdbx\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"passwd\" -o -name \"autologin.conf\" -o -name \"*vnc*.ini\" -o -name \"*.ovpn\" -o -name \".recently-used.xbel\" -o -name \"rsyncd.conf\" -o -name \"wsl.exe\" -o -name \"hostapd.conf\" -o -name \"ffftp.ini\" -o -name \"authorized_hosts\" -o -name \".secrets.mkey\" -o -name \"*.swp\" -o -name \".sudo_as_admin_successful\" -o -name \"unattended.xml\" -o -name \"credentials.db\" -o -name \"filezilla.xml\" -o -name \"backup\" -o -name \"pg_hba.conf\" -o -name \"*.der\" -o -name \"*.jks\" -o -name \"NetSetup.log\" -o -name \"*.timer\" -o -name \"pgadmin*.db\" -o -name \"*.csr\" -o -name \"scclient.exe\" -o -name \"RDCMan.settings\" -o -name \".git-credentials\" -o -name \"sysprep.xml\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"settings.php\" -o -name \"ipsec.secrets\" -o -name \"mariadb.cnf\" -o -name \"sess_*\" -o -name \"known_hosts\" -o -name \"influxdb.conf\" -o -name \".wgetrc\" -o -name \"mongod*.conf\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"fastcgi_params\" -o -name \"storage.php\" -o -name \"*.sqlite3\" -o -name \"*config*.php\" -o -name \"redis.conf\" -o -name \"zabbix_server.conf\" -o -name \"php.ini\" -o -name \"error.log\" -o -name \"ftp.ini\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"snmpd.conf\" -o -name \"setupinfo.bak\" -o -name \"drives.xml\" -o -name \"setupinfo\" -o -name \"*.cer\" -o -name \"hosts.equiv\" -o -name \"pgsql.conf\" -o -name \"kadm5.acl\" -o -name \"credentials\" -o -name \"sites.ini\" -o -name \"*.crt\" -o -name \"sitemanager.xml\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".msmtprc\" -o -name \"appcmd.exe\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \"supervisord.conf\" -o -name \"web*.config\" -o -name \"*.socket\" -o -name \"gitlab.rm\" -o -name \"sysprep.inf\" -o -name \"*.sqlite\" -o -name \"bash.exe\" -o -name \".git\" -o -name \"my.cnf\" -o -name \"backups\" -o -name \"httpd.conf\" -o -name \".github\" -o -name \"db.php\" -o -name \".bashrc\" -o -name \"unattend.txt\" -o -name \"*.viminfo\" -o -name \"default.sav\" -o -name \"*_history*\" -o -name \"*.gpg\" -o -name \"config.php\" -o -name \"software.sav\" -o -name \".profile\" -o -name \"*.pem\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"KeePass.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.service\" -o -name \"KeePass.config*\" -o -name \"docker-compose.yml\" -o -name \"psk.txt\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"gitlab.yml\" -o -name \".lesshst\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.keystore\" -o -name \"cesi.conf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.db\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"*.gnupg\" -o -name \".gitconfig\" -o -name \".erlang.cookie\" -o -name \"mosquitto.conf\" -o -name \"000-default.conf\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"creds*\" -o -name \"docker.sock\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.rdg\" -o -name \"index.dat\" -o -name \"*.p12\" -o -name \"zabbix_agentd.conf\" -o -name \"sssd.conf\" -o -name \"ddclient.conf\" -o -name \"kcpassword\" -o -name \"kibana.y*ml\" -o -name \"*.pgp\" -o -name \".htpasswd\" -o -name \"AzureRMContext.json\" -o -name \"racoon.conf\" -o -name \"AppEvent.Evt\" -o -name \"ntuser.dat\" -o -name \"*vnc*.c*nf*\" -o -name \"protecteduserkey.bin\" -o -name \".ldaprc\" -o -name \".rhosts\" -o -name \"datasources.xml\" -o -name \"https-xampp.conf\" -o -name \"*.pfx\" -o -name \"access.log\" -o -name \"access_tokens.json\" -o -name \"gvm-tools.conf\" -o -name \"*vnc*.xml\" -o -name \"recentservers.xml\" -o -name \"SYSTEM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^$GREPHOMESEARCH|^/system|^/snap|^/applications|^/bin|^/media|^/lib64|^/mnt|^/run|^/systemd|^/sys|^/private|^/opt|^/cdrom|^/lib32|^/etc|^/lib|^/.cache|^/sbin|^/tmp|^/usr|^/var|^/srv" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^$GREPHOMESEARCH|^/system|^/snap|^/applications|^/bin|^/media|^/lib64|^/mnt|^/run|^/systemd|^/sys|^/private|^/opt|^/cdrom|^/lib32|^/etc|^/lib|^/.cache|^/sbin|^/tmp|^/usr|^/var|^/srv" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^$GREPHOMESEARCH|^/system|^/snap|^/applications|^/bin|^/media|^/lib64|^/mnt|^/run|^/systemd|^/sys|^/private|^/opt|^/cdrom|^/lib32|^/etc|^/lib|^/.cache|^/sbin|^/tmp|^/usr|^/var|^/srv" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/tmp|^/mnt|^/private|^/var" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/default/settings.php' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E 'moodle/config.php' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '/lib' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E 'README.gnupg' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/usr|^/etc|^/var" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SRV\n$FIND_DIR_APPLICATIONS"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_ETC\n$FIND_LIB64\n$FIND_SYS\n$FIND_SNAP\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_BIN\n$FIND_LIB32\n$FIND_VAR\n$FIND_LIB\n$FIND_USR\n$FIND_SBIN\n$FIND_TMP\n$FIND_MNT\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_OPT"  | grep -E "^/sbin|^$GREPHOMESEARCH|^/tmp|^/usr|^/mnt|^/snap|^/bin|^/private|^/applications|^/opt|^/cdrom|^/var|^/etc|^/srv|^/.cache|^/media" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
