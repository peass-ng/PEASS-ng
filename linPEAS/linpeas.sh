...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"bind\" -o -name \".bluemix\" -o -name \"system.d\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"bind\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \".cloudflared\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"*knockd*\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \"ssh*config\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"sess_*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"sess_*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"agent*\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.timer\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"sess_*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"agent*\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \"ssh*config\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"pgadmin*.db\" -o -name \"docker-compose.yml\" -o -name \"db.php\" -o -name \"ipsec.secrets\" -o -name \"ipsec.conf\" -o -name \".recently-used.xbel\" -o -name \"my.ini\" -o -name \"ws_ftp.ini\" -o -name \"SAM\" -o -name \"SecEvent.Evt\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \"vault-ssh-helper.hcl\" -o -name \"ntuser.dat\" -o -name \"database.php\" -o -name \"*.viminfo\" -o -name \"autologin.conf\" -o -name \"credentials.db\" -o -name \"KeePass.config*\" -o -name \"fastcgi_params\" -o -name \"gvm-tools.conf\" -o -name \"*.csr\" -o -name \"docker.sock\" -o -name \"*.timer\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"*.swp\" -o -name \"SYSTEM\" -o -name \"mongod*.conf\" -o -name \"Ntds.dit\" -o -name \"*.gnupg\" -o -name \"Dockerfile\" -o -name \"ConsoleHost_history.txt\" -o -name \"kibana.y*ml\" -o -name \"*.keystore\" -o -name \"*credential*\" -o -name \"snmpd.conf\" -o -name \"groups.xml\" -o -name \"elasticsearch.y*ml\" -o -name \"*.key\" -o -name \"server.xml\" -o -name \".github\" -o -name \"AzureRMContext.json\" -o -name \"*.pfx\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"https-xampp.conf\" -o -name \"php.ini\" -o -name \"credentials\" -o -name \"id_dsa*\" -o -name \".vault-token\" -o -name \"software.sav\" -o -name \"authorized_hosts\" -o -name \"postgresql.conf\" -o -name \"recentservers.xml\" -o -name \".*_history.*\" -o -name \".pypirc\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \"wp-config.php\" -o -name \"bash.exe\" -o -name \"rsyncd.secrets\" -o -name \"my.cnf\" -o -name \"*.der\" -o -name \"system.sav\" -o -name \"setupinfo\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"gitlab.rm\" -o -name \".profile\" -o -name \"ddclient.conf\" -o -name \"azureProfile.json\" -o -name \"storage.php\" -o -name \"*.crt\" -o -name \"appcmd.exe\" -o -name \"krb5.conf\" -o -name \"ftp.ini\" -o -name \"cesi.conf\" -o -name \"filezilla.xml\" -o -name \".bashrc\" -o -name \"access_tokens.json\" -o -name \"index.dat\" -o -name \"KeePass.enforced*\" -o -name \"*.rdg\" -o -name \"winscp.ini\" -o -name \".rhosts\" -o -name \"unattended.xml\" -o -name \".ldaprc\" -o -name \"accessTokens.json\" -o -name \"kcpassword\" -o -name \"NetSetup.log\" -o -name \"backup\" -o -name \"krb5.keytab\" -o -name \"sysprep.xml\" -o -name \".msmtprc\" -o -name \"gitlab.yml\" -o -name \"scheduledtasks.xml\" -o -name \"*vnc*.txt\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \"passwd\" -o -name \"*password*\" -o -name \"sess_*\" -o -name \"rsyncd.conf\" -o -name \"supervisord.conf\" -o -name \"secrets.yml\" -o -name \"*.sqlite\" -o -name \"*.db\" -o -name \"printers.xml\" -o -name \"access.log\" -o -name \"settings.php\" -o -name \"mosquitto.conf\" -o -name \"system\" -o -name \".lesshst\" -o -name \".git-credentials\" -o -name \"*.p12\" -o -name \"unattend.inf\" -o -name \"protecteduserkey.bin\" -o -name \"*.gpg\" -o -name \"*.jks\" -o -name \"*.ovpn\" -o -name \"security.sav\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"AppEvent.Evt\" -o -name \"pagefile.sys\" -o -name \"wsl.exe\" -o -name \"web*.config\" -o -name \"unattend.txt\" -o -name \"*.kdbx\" -o -name \".htpasswd\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*vnc*.ini\" -o -name \"known_hosts\" -o -name \"redis.conf\" -o -name \"creds*\" -o -name \"access_tokens.db\" -o -name \"backups\" -o -name \".env\" -o -name \"docker.socket\" -o -name \".git\" -o -name \"ffftp.ini\" -o -name \".google_authenticator\" -o -name \"KeePass.ini\" -o -name \".k5login\" -o -name \"autologin\" -o -name \"error.log\" -o -name \".erlang.cookie\" -o -name \"*.socket\" -o -name \"software\" -o -name \"authorized_keys\" -o -name \"hosts.equiv\" -o -name \"datasources.xml\" -o -name \"scclient.exe\" -o -name \"https.conf\" -o -name \".gitconfig\" -o -name \"RDCMan.settings\" -o -name \"config.php\" -o -name \"*.cer\" -o -name \"kadm5.acl\" -o -name \"anaconda-ks.cfg\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"hostapd.conf\" -o -name \"ftp.config\" -o -name \"id_rsa*\" -o -name \"*vnc*.c*nf*\" -o -name \"httpd.conf\" -o -name \".plan\" -o -name \"*.pgp\" -o -name \"wcx_ftp.ini\" -o -name \"000-default.conf\" -o -name \"*vnc*.xml\" -o -name \"TokenCache.dat\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/srv|^/cdrom|^/var|^/mnt|^/systemd|^/usr|^/etc|^/lib64|^$GREPHOMESEARCH|^/tmp|^/bin|^/system|^/private|^/lib32|^/opt|^/sbin|^/snap|^/media|^/.cache|^/applications|^/sys|^/lib|^/run" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/srv|^/cdrom|^/var|^/mnt|^/systemd|^/usr|^/etc|^/lib64|^$GREPHOMESEARCH|^/tmp|^/bin|^/system|^/private|^/lib32|^/opt|^/sbin|^/snap|^/media|^/.cache|^/applications|^/sys|^/lib|^/run" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/srv|^/cdrom|^/var|^/mnt|^/systemd|^/usr|^/etc|^/lib64|^$GREPHOMESEARCH|^/tmp|^/bin|^/system|^/private|^/lib32|^/opt|^/sbin|^/snap|^/media|^/.cache|^/applications|^/sys|^/lib|^/run" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_MYSQL=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E '/default/settings.php' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E 'moodle/config.php' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/tmp|^/private" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^$GREPHOMESEARCH|^/usr" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E '/lib' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E 'README.gnupg' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_PRIVATE\n$FIND_DIR_USR\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_ETC\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_LIB64\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_CDROM\n$FIND_SNAP\n$FIND_APPLICATIONS\n$FIND_LIB32\n$FIND_SBIN\n$FIND_SYS\n$FIND_BIN\n$FIND_ETC\n$FIND_SRV\n$FIND_TMP\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CACHE\n$FIND_RUN\n$FIND_MNT\n$FIND_OPT\n$FIND_HOMESEARCH\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB"  | grep -E "^/sbin|^/etc|^/snap|^/srv|^$GREPHOMESEARCH|^/media|^/cdrom|^/tmp|^/.cache|^/bin|^/private|^/var|^/applications|^/mnt|^/usr|^/opt" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
