...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \"system.d\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"logstash\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \".svn\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"couchdb\" -o -name \"filezilla\" -o -name \"sites-enabled\" -o -name \"neo4j\" -o -name \"ldap\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".vnc\" -o -name \"mysql\" -o -name \"cacti\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"*knockd*\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ssh*config\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \"sess_*\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \"sess_*\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"agent*\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.timer\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \"sess_*\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"agent*\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ssh*config\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"*.socket\" -o -name \"*.der\" -o -name \".git\" -o -name \"000-default.conf\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"KeePass.enforced*\" -o -name \"*.service\" -o -name \".git-credentials\" -o -name \"sites.ini\" -o -name \"sess_*\" -o -name \".bashrc\" -o -name \".profile\" -o -name \"ffftp.ini\" -o -name \"gitlab.yml\" -o -name \"*.kdbx\" -o -name \"software.sav\" -o -name \"*.crt\" -o -name \"storage.php\" -o -name \"SAM\" -o -name \"ftp.ini\" -o -name \"index.dat\" -o -name \"*credential*\" -o -name \"*.csr\" -o -name \"KeePass.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"*.pem\" -o -name \".rhosts\" -o -name \"https-xampp.conf\" -o -name \"docker.sock\" -o -name \"backup\" -o -name \"httpd.conf\" -o -name \".env\" -o -name \"https.conf\" -o -name \".google_authenticator\" -o -name \"security.sav\" -o -name \"snmpd.conf\" -o -name \"gvm-tools.conf\" -o -name \"*.sqlite3\" -o -name \"*.keyring\" -o -name \"sysprep.inf\" -o -name \"*.jks\" -o -name \"*.rdg\" -o -name \"wcx_ftp.ini\" -o -name \"php.ini\" -o -name \"SecEvent.Evt\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"pagefile.sys\" -o -name \"credentials\" -o -name \"accessTokens.json\" -o -name \"recentservers.xml\" -o -name \"wp-config.php\" -o -name \"TokenCache.dat\" -o -name \"*.key\" -o -name \"id_rsa*\" -o -name \"RDCMan.settings\" -o -name \"hostapd.conf\" -o -name \"iis6.log\" -o -name \".ldaprc\" -o -name \"printers.xml\" -o -name \".github\" -o -name \"gitlab.rm\" -o -name \"datasources.xml\" -o -name \"sysprep.xml\" -o -name \"*.swp\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"system\" -o -name \"kadm5.acl\" -o -name \"docker-compose.yml\" -o -name \".recently-used.xbel\" -o -name \"my.cnf\" -o -name \"ftp.config\" -o -name \"pgadmin*.db\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"*.db\" -o -name \"NetSetup.log\" -o -name \"fastcgi_params\" -o -name \"krb5.conf\" -o -name \"*.p12\" -o -name \"ntuser.dat\" -o -name \"*.pgp\" -o -name \".k5login\" -o -name \"*vnc*.c*nf*\" -o -name \"SYSTEM\" -o -name \"*password*\" -o -name \"creds*\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"KeePass.config*\" -o -name \"id_dsa*\" -o -name \"winscp.ini\" -o -name \"pg_hba.conf\" -o -name \"rsyncd.conf\" -o -name \"postgresql.conf\" -o -name \"hosts.equiv\" -o -name \"*.pfx\" -o -name \"protecteduserkey.bin\" -o -name \"access_tokens.db\" -o -name \"*config*.php\" -o -name \"authorized_keys\" -o -name \"my.ini\" -o -name \"unattended.xml\" -o -name \"autologin.conf\" -o -name \".erlang.cookie\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"secrets.yml\" -o -name \"AppEvent.Evt\" -o -name \"ws_ftp.ini\" -o -name \"supervisord.conf\" -o -name \"*.viminfo\" -o -name \"access.log\" -o -name \"*vnc*.ini\" -o -name \"wsl.exe\" -o -name \"db.php\" -o -name \"*.ftpconfig\" -o -name \"database.php\" -o -name \"elasticsearch.y*ml\" -o -name \"system.sav\" -o -name \"unattend.inf\" -o -name \"mongod*.conf\" -o -name \"access_tokens.json\" -o -name \"backups\" -o -name \"azureProfile.json\" -o -name \"scclient.exe\" -o -name \"tomcat-users.xml\" -o -name \"Dockerfile\" -o -name \"error.log\" -o -name \"*.ovpn\" -o -name \"pgsql.conf\" -o -name \".plan\" -o -name \"ddclient.conf\" -o -name \"FreeSSHDservice.ini\" -o -name \"cesi.conf\" -o -name \"kcpassword\" -o -name \"default.sav\" -o -name \"ipsec.conf\" -o -name \"setupinfo.bak\" -o -name \"vault-ssh-helper.hcl\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"appcmd.exe\" -o -name \"krb5.keytab\" -o -name \".pypirc\" -o -name \"kibana.y*ml\" -o -name \"*vnc*.txt\" -o -name \"drives.xml\" -o -name \"settings.php\" -o -name \"*.gpg\" -o -name \"redis.conf\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"*vnc*.xml\" -o -name \".msmtprc\" -o -name \"*.sqlite\" -o -name \"authorized_hosts\" -o -name \"web*.config\" -o -name \"software\" -o -name \"config.php\" -o -name \"known_hosts\" -o -name \"ipsec.secrets\" -o -name \"*.keystore\" -o -name \".*_history.*\" -o -name \"*.cer\" -o -name \"sitemanager.xml\" -o -name \"AzureRMContext.json\" -o -name \"filezilla.xml\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.xml\" -o -name \"scheduledtasks.xml\" -o -name \".lesshst\" -o -name \"rsyncd.secrets\" -o -name \"debian.cnf\" -o -name \"docker.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/lib64|^/run|^/var|^/system|^/lib32|^/opt|^/srv|^/private|^/snap|^/tmp|^/systemd|^/etc|^/sbin|^/cdrom|^/applications|^/.cache|^/mnt|^/sys|^$GREPHOMESEARCH|^/lib|^/usr" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/lib64|^/run|^/var|^/system|^/lib32|^/opt|^/srv|^/private|^/snap|^/tmp|^/systemd|^/etc|^/sbin|^/cdrom|^/applications|^/.cache|^/mnt|^/sys|^$GREPHOMESEARCH|^/lib|^/usr" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/lib64|^/run|^/var|^/system|^/lib32|^/opt|^/srv|^/private|^/snap|^/tmp|^/systemd|^/etc|^/sbin|^/cdrom|^/applications|^/.cache|^/mnt|^/sys|^$GREPHOMESEARCH|^/lib|^/usr" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/tmp|^/var|^/private|^/mnt" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E '/default/settings.php' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E 'moodle/config.php' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E '/lib' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E 'README.gnupg' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_VAR\n$FIND_DIR_ETC\n$FIND_DIR_CACHE\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_USR\n$FIND_DIR_OPT\n$FIND_DIR_BIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_TMP\n$FIND_SYSTEMD\n$FIND_SNAP\n$FIND_SYSTEM\n$FIND_PRIVATE\n$FIND_USR\n$FIND_LIB\n$FIND_CACHE\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SBIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_ETC\n$FIND_LIB64\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_BIN\n$FIND_VAR\n$FIND_OPT\n$FIND_CDROM\n$FIND_MEDIA"  | grep -E "^/bin|^/media|^/.cache|^/private|^/snap|^/etc|^/tmp|^/sbin|^/mnt|^/var|^$GREPHOMESEARCH|^/cdrom|^/usr|^/opt|^/srv|^/applications" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
