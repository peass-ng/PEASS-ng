...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"system.d\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \"bind\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \"bind\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"seeddms*\" -o -name \"postfix\" -o -name \"neo4j\" -o -name \"sentry\" -o -name \"ldap\" -o -name \"environments\" -o -name \"keyrings\" -o -name \"logstash\" -o -name \".vnc\" -o -name \"roundcube\" -o -name \"bind\" -o -name \".irssi\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"sites-enabled\" -o -name \"cacti\" -o -name \".cloudflared\" -o -name \"mysql\" -o -name \".bluemix\" -o -name \"filezilla\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"*knockd*\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"ssh*config\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"sess_*\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"agent*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"sess_*\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.timer\" -o -name \"*.service\" -o -name \"*.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"agent*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"sess_*\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"ssh*config\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"access.log\" -o -name \"debian.cnf\" -o -name \"*.pem\" -o -name \"software\" -o -name \"scheduledtasks.xml\" -o -name \"config.php\" -o -name \"*.pfx\" -o -name \".plan\" -o -name \"id_dsa*\" -o -name \"*.csr\" -o -name \"legacy_credentials.db\" -o -name \"kcpassword\" -o -name \"iis6.log\" -o -name \"autologin\" -o -name \"mariadb.cnf\" -o -name \"RDCMan.settings\" -o -name \"sysprep.inf\" -o -name \"*.timer\" -o -name \"datasources.xml\" -o -name \"backups\" -o -name \".erlang.cookie\" -o -name \"winscp.ini\" -o -name \"Ntds.dit\" -o -name \"settings.php\" -o -name \"*vnc*.c*nf*\" -o -name \"ipsec.secrets\" -o -name \"backup\" -o -name \"*.kdbx\" -o -name \"*password*\" -o -name \"secrets.yml\" -o -name \".github\" -o -name \"access_tokens.db\" -o -name \".htpasswd\" -o -name \"KeePass.enforced*\" -o -name \"cloud.cfg\" -o -name \"id_rsa*\" -o -name \"*.ovpn\" -o -name \"server.xml\" -o -name \"wp-config.php\" -o -name \".*_history.*\" -o -name \"wcx_ftp.ini\" -o -name \"bash.exe\" -o -name \"index.dat\" -o -name \"printers.xml\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"database.php\" -o -name \"docker-compose.yml\" -o -name \"ftp.config\" -o -name \"elasticsearch.y*ml\" -o -name \"psk.txt\" -o -name \"recentservers.xml\" -o -name \"hosts.equiv\" -o -name \"*.key\" -o -name \"sysprep.xml\" -o -name \"ws_ftp.ini\" -o -name \"pgadmin*.db\" -o -name \"*config*.php\" -o -name \".k5login\" -o -name \"unattended.xml\" -o -name \"access_tokens.json\" -o -name \"my.ini\" -o -name \"TokenCache.dat\" -o -name \"*.keystore\" -o -name \"ConsoleHost_history.txt\" -o -name \".sudo_as_admin_successful\" -o -name \"postgresql.conf\" -o -name \"000-default.conf\" -o -name \"httpd.conf\" -o -name \"unattend.inf\" -o -name \"*.swp\" -o -name \"*.sqlite\" -o -name \"Dockerfile\" -o -name \"authorized_hosts\" -o -name \"*.cer\" -o -name \"gitlab.rm\" -o -name \"error.log\" -o -name \"credentials\" -o -name \"authorized_keys\" -o -name \"*.der\" -o -name \"setupinfo\" -o -name \".ldaprc\" -o -name \".wgetrc\" -o -name \"*.jks\" -o -name \"*.viminfo\" -o -name \"pgsql.conf\" -o -name \"passwd\" -o -name \".vault-token\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"mongod*.conf\" -o -name \"*.socket\" -o -name \"cesi.conf\" -o -name \"*.p12\" -o -name \"krb5.keytab\" -o -name \"gitlab.yml\" -o -name \"*.pgp\" -o -name \"FreeSSHDservice.ini\" -o -name \"https.conf\" -o -name \".rhosts\" -o -name \"my.cnf\" -o -name \"storage.php\" -o -name \"*vnc*.xml\" -o -name \"accessTokens.json\" -o -name \"azureProfile.json\" -o -name \"drives.xml\" -o -name \"*.keyring\" -o -name \"sites.ini\" -o -name \"*.ftpconfig\" -o -name \".pypirc\" -o -name \"docker.sock\" -o -name \"ddclient.conf\" -o -name \"NetSetup.log\" -o -name \"*.gnupg\" -o -name \"sentry.conf.py\" -o -name \"SYSTEM\" -o -name \"groups.xml\" -o -name \"known_hosts\" -o -name \"mosquitto.conf\" -o -name \".lesshst\" -o -name \"sess_*\" -o -name \"https-xampp.conf\" -o -name \"autologin.conf\" -o -name \"system.sav\" -o -name \"scclient.exe\" -o -name \"anaconda-ks.cfg\" -o -name \"unattend.txt\" -o -name \"ffftp.ini\" -o -name \".bashrc\" -o -name \"AzureRMContext.json\" -o -name \"redis.conf\" -o -name \"gvm-tools.conf\" -o -name \"security.sav\" -o -name \".profile\" -o -name \"ftp.ini\" -o -name \"kadm5.acl\" -o -name \".recently-used.xbel\" -o -name \"krb5.conf\" -o -name \"ipsec.conf\" -o -name \"rsyncd.conf\" -o -name \"KeePass.config*\" -o -name \"*.service\" -o -name \"setupinfo.bak\" -o -name \"*.crt\" -o -name \"SecEvent.Evt\" -o -name \"SAM\" -o -name \"vault-ssh-helper.hcl\" -o -name \".google_authenticator\" -o -name \"unattend.xml\" -o -name \"wsl.exe\" -o -name \"*vnc*.ini\" -o -name \"pg_hba.conf\" -o -name \"*.rdg\" -o -name \"default.sav\" -o -name \"AppEvent.Evt\" -o -name \"sitemanager.xml\" -o -name \"filezilla.xml\" -o -name \"docker.socket\" -o -name \"*.sqlite3\" -o -name \"ntuser.dat\" -o -name \"*credential*\" -o -name \"*vnc*.txt\" -o -name \"*.gpg\" -o -name \"creds*\" -o -name \"hostapd.conf\" -o -name \"software.sav\" -o -name \"db.php\" -o -name \"tomcat-users.xml\" -o -name \"credentials.db\" -o -name \".env\" -o -name \"rsyncd.secrets\" -o -name \"appcmd.exe\" -o -name \"fastcgi_params\" -o -name \".git-credentials\" -o -name \".gitconfig\" -o -name \"*.db\" -o -name \"supervisord.conf\" -o -name \"racoon.conf\" -o -name \"passbolt.php\" -o -name \"protecteduserkey.bin\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"pagefile.sys\" -o -name \".msmtprc\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/applications|^/cdrom|^/etc|^/sys|^/snap|^/var|^/tmp|^/opt|^/mnt|^/lib32|^/lib64|^/lib|^/system|^/usr|^/sbin|^/media|^/srv|^$GREPHOMESEARCH|^/.cache|^/bin|^/systemd|^/private|^/run" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/applications|^/cdrom|^/etc|^/sys|^/snap|^/var|^/tmp|^/opt|^/mnt|^/lib32|^/lib64|^/lib|^/system|^/usr|^/sbin|^/media|^/srv|^$GREPHOMESEARCH|^/.cache|^/bin|^/systemd|^/private|^/run" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/applications|^/cdrom|^/etc|^/sys|^/snap|^/var|^/tmp|^/opt|^/mnt|^/lib32|^/lib64|^/lib|^/system|^/usr|^/sbin|^/media|^/srv|^$GREPHOMESEARCH|^/.cache|^/bin|^/systemd|^/private|^/run" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/mnt|^/tmp|^/var|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E '/default/settings.php' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E 'moodle/config.php' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E '/lib' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E 'README.gnupg' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/usr|^/var|^/etc" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_OPT\n$FIND_DIR_SNAP\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_LIB32\n$FIND_CACHE\n$FIND_MNT\n$FIND_OPT\n$FIND_SYS\n$FIND_CDROM\n$FIND_APPLICATIONS\n$FIND_ETC\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_RUN\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SRV\n$FIND_SNAP\n$FIND_LIB\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_MEDIA\n$FIND_BIN"  | grep -E "^/bin|^/applications|^/mnt|^/cdrom|^/snap|^/var|^/etc|^/usr|^/sbin|^/media|^/tmp|^/private|^/srv|^/.cache|^$GREPHOMESEARCH|^/opt" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
