...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  PSTORAGE_SOCKET=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/sbin|^/media|^/.cache|^/run|^/bin|^/etc|^/srv|^/applications|^/mnt|^/sys|^/opt|^/lib32|^$GREPHOMESEARCH|^/private|^/snap|^/tmp|^/usr|^/system|^/systemd|^/var|^/lib64|^/lib|^/cdrom" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/mnt|^/var|^/private|^/tmp" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E '/default/settings.php' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E 'moodle/config.php' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E '/lib' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E 'README.gnupg' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/var|^/etc|^/usr" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SBIN\n$FIND_DIR_CACHE\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_ETC\n$FIND_DIR_SNAP\n$FIND_DIR_MNT"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_CACHE\n$FIND_RUN\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_USR\n$FIND_SRV\n$FIND_HOMESEARCH\n$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_CDROM\n$FIND_SBIN\n$FIND_BIN\n$FIND_PRIVATE\n$FIND_APPLICATIONS\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB\n$FIND_SYS\n$FIND_MNT\n$FIND_ETC\n$FIND_SNAP\n$FIND_TMP\n$FIND_VAR"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
