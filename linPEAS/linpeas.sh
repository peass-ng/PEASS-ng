...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"mysql\" -o -name \".vnc\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"system.d\" -o -name \"bind\" -o -name \"keyrings\" -o -name \"seeddms*\" -o -name \".bluemix\" -o -name \"cacti\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \".vnc\" -o -name \"mysql\" -o -name \"logstash\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"bind\" -o -name \"seeddms*\" -o -name \"keyrings\" -o -name \"cacti\" -o -name \".bluemix\" -o -name \".irssi\" -o -name \"filezilla\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"*knockd*\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \"ssh*config\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"sess_*\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"agent*\" -o -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"sess_*\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"agent*\" -o -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"sess_*\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \"ssh*config\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \".vault-token\" -o -name \".recently-used.xbel\" -o -name \"gvm-tools.conf\" -o -name \"*.keyring\" -o -name \"KeePass.enforced*\" -o -name \"*.der\" -o -name \".plan\" -o -name \"sysprep.xml\" -o -name \"credentials\" -o -name \".git-credentials\" -o -name \"iis6.log\" -o -name \"*password*\" -o -name \"wcx_ftp.ini\" -o -name \"*vnc*.ini\" -o -name \"accessTokens.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \".*_history.*\" -o -name \"*.gnupg\" -o -name \"docker.socket\" -o -name \"id_dsa*\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"*.sqlite3\" -o -name \"backup\" -o -name \"pgsql.conf\" -o -name \"autologin\" -o -name \"my.ini\" -o -name \"*.socket\" -o -name \".lesshst\" -o -name \"appcmd.exe\" -o -name \"*vnc*.c*nf*\" -o -name \"creds*\" -o -name \"snmpd.conf\" -o -name \"AzureRMContext.json\" -o -name \"access_tokens.json\" -o -name \"software.sav\" -o -name \"docker-compose.yml\" -o -name \".pypirc\" -o -name \"postgresql.conf\" -o -name \".htpasswd\" -o -name \".gitconfig\" -o -name \"datasources.xml\" -o -name \"authorized_hosts\" -o -name \"*.pem\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"sysprep.inf\" -o -name \".github\" -o -name \"rsyncd.secrets\" -o -name \"https-xampp.conf\" -o -name \"id_rsa*\" -o -name \"ws_ftp.ini\" -o -name \"*config*.php\" -o -name \"KeePass.ini\" -o -name \"azureProfile.json\" -o -name \"access.log\" -o -name \"hostapd.conf\" -o -name \".erlang.cookie\" -o -name \"error.log\" -o -name \"ftp.config\" -o -name \"groups.xml\" -o -name \".google_authenticator\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"protecteduserkey.bin\" -o -name \"kadm5.acl\" -o -name \".env\" -o -name \"ffftp.ini\" -o -name \"cesi.conf\" -o -name \"https.conf\" -o -name \"my.cnf\" -o -name \"autologin.conf\" -o -name \"mongod*.conf\" -o -name \"*.viminfo\" -o -name \".sudo_as_admin_successful\" -o -name \"pgadmin*.db\" -o -name \"*.jks\" -o -name \".profile\" -o -name \"passwd\" -o -name \"Dockerfile\" -o -name \"KeePass.config*\" -o -name \".git\" -o -name \"server.xml\" -o -name \"*.timer\" -o -name \"sess_*\" -o -name \"*.ovpn\" -o -name \"known_hosts\" -o -name \"system\" -o -name \"*.rdg\" -o -name \"credentials.db\" -o -name \"security.sav\" -o -name \"access_tokens.db\" -o -name \"hosts.equiv\" -o -name \"tomcat-users.xml\" -o -name \".msmtprc\" -o -name \"RDCMan.settings\" -o -name \"winscp.ini\" -o -name \"*.keystore\" -o -name \"FreeSSHDservice.ini\" -o -name \"unattended.xml\" -o -name \".k5login\" -o -name \"NetSetup.log\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"recentservers.xml\" -o -name \"printers.xml\" -o -name \"setupinfo.bak\" -o -name \"default.sav\" -o -name \"*credential*\" -o -name \"SAM\" -o -name \"000-default.conf\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"*.gpg\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"web*.config\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \"ddclient.conf\" -o -name \"db.php\" -o -name \"SYSTEM\" -o -name \"unattend.txt\" -o -name \"gitlab.rm\" -o -name \"*.db\" -o -name \"SecEvent.Evt\" -o -name \"redis.conf\" -o -name \"wp-config.php\" -o -name \"system.sav\" -o -name \"scheduledtasks.xml\" -o -name \"setupinfo\" -o -name \"*.kdbx\" -o -name \"ipsec.secrets\" -o -name \"kcpassword\" -o -name \"httpd.conf\" -o -name \"index.dat\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"legacy_credentials.db\" -o -name \"cloud.cfg\" -o -name \".bashrc\" -o -name \"ftp.ini\" -o -name \".rhosts\" -o -name \"filezilla.xml\" -o -name \"mosquitto.conf\" -o -name \"*.pfx\" -o -name \"anaconda-ks.cfg\" -o -name \"php.ini\" -o -name \"*vnc*.xml\" -o -name \"*.p12\" -o -name \"backups\" -o -name \"unattend.xml\" -o -name \".ldaprc\" -o -name \"secrets.yml\" -o -name \"ntuser.dat\" -o -name \"pagefile.sys\" -o -name \"AppEvent.Evt\" -o -name \"elasticsearch.y*ml\" -o -name \"*.service\" -o -name \"*.cer\" -o -name \"wsl.exe\" -o -name \"ipsec.conf\" -o -name \"*vnc*.txt\" -o -name \"storage.php\" -o -name \"*.key\" -o -name \"*.pgp\" -o -name \"TokenCache.dat\" -o -name \"database.php\" -o -name \"bash.exe\" -o -name \"sites.ini\" -o -name \"supervisord.conf\" -o -name \"krb5.conf\" -o -name \"rsyncd.conf\" -o -name \"*.sqlite\" -o -name \"Ntds.dit\" -o -name \"pg_hba.conf\" -o -name \"krb5.keytab\" -o -name \"unattend.inf\" -o -name \"scclient.exe\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/cdrom|^/etc|^/opt|^/tmp|^/usr|^/var|^/sys|^/private|^/run|^/applications|^/system|^/snap|^/bin|^/lib|^/sbin|^/mnt|^/lib32|^/srv|^/media|^/systemd|^/lib64|^/.cache" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/cdrom|^/etc|^/opt|^/tmp|^/usr|^/var|^/sys|^/private|^/run|^/applications|^/system|^/snap|^/bin|^/lib|^/sbin|^/mnt|^/lib32|^/srv|^/media|^/systemd|^/lib64|^/.cache" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/cdrom|^/etc|^/opt|^/tmp|^/usr|^/var|^/sys|^/private|^/run|^/applications|^/system|^/snap|^/bin|^/lib|^/sbin|^/mnt|^/lib32|^/srv|^/media|^/systemd|^/lib64|^/.cache" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "mysql$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/mnt|^/private|^/tmp|^/var" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E '/default/settings.php' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E 'moodle/config.php' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM\n$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E '/lib' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E 'README.gnupg' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_VAR\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_SRV\n$FIND_DIR_CDROM\n$FIND_DIR_BIN\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_SBIN"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_HOMESEARCH\n$FIND_CACHE\n$FIND_LIB32\n$FIND_VAR\n$FIND_ETC\n$FIND_LIB64\n$FIND_OPT\n$FIND_USR\n$FIND_SYSTEMD\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_MNT\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_RUN\n$FIND_BIN\n$FIND_LIB\n$FIND_PRIVATE\n$FIND_SYS\n$FIND_CDROM"  | grep -E "^$GREPHOMESEARCH|^/private|^/opt|^/cdrom|^/etc|^/srv|^/tmp|^/snap|^/bin|^/media|^/usr|^/var|^/.cache|^/sbin|^/applications|^/mnt" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
