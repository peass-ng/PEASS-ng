...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"logstash\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \"system.d\" -o -name \"mysql\" -o -name \"bind\" -o -name \"environments\" -o -name \"cacti\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" -o -name \"ldap\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"sentry\" -o -name \"logstash\" -o -name \"environments\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \"couchdb\" -o -name \".bluemix\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".cloudflared\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".svn\" -o -name \".irssi\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"logstash\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \"bind\" -o -name \"environments\" -o -name \"cacti\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" -o -name \"ldap\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"logstash\" -o -name \".bluemix\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \"bind\" -o -name \"environments\" -o -name \"cacti\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"filezilla\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"postfix\" -o -name \"ldap\" -o -name \".svn\" -o -name \".irssi\" -o -name \"sentry\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"*knockd*\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"ssh*config\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"postgresql.conf\" -o -name \"mongod*.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"sess_*\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"postgresql.conf\" -o -name \"mongod*.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"agent*\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"sess_*\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"postgresql.conf\" -o -name \"mongod*.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"agent*\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"sess_*\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mongod*.conf\" -o -name \"postgresql.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"ssh*config\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \".erlang.cookie\" -o -name \"unattend.inf\" -o -name \"*.ftpconfig\" -o -name \"debian.cnf\" -o -name \".git\" -o -name \"snmpd.conf\" -o -name \"psk.txt\" -o -name \"mosquitto.conf\" -o -name \"php.ini\" -o -name \"TokenCache.dat\" -o -name \"settings.php\" -o -name \"*.pgp\" -o -name \"autologin.conf\" -o -name \".profile\" -o -name \".vault-token\" -o -name \"krb5.conf\" -o -name \"cloud.cfg\" -o -name \"ntuser.dat\" -o -name \"wcx_ftp.ini\" -o -name \"id_dsa*\" -o -name \"pgadmin*.db\" -o -name \"vault-ssh-helper.hcl\" -o -name \"postgresql.conf\" -o -name \"mongod*.conf\" -o -name \"db.php\" -o -name \"*.swp\" -o -name \"KeePass.config*\" -o -name \"*.keystore\" -o -name \"ffftp.ini\" -o -name \"software\" -o -name \"*.cer\" -o -name \".msmtprc\" -o -name \"docker.sock\" -o -name \"credentials\" -o -name \"*.gpg\" -o -name \"docker-compose.yml\" -o -name \"Dockerfile\" -o -name \"backup\" -o -name \"*.pfx\" -o -name \"Ntds.dit\" -o -name \"krb5.keytab\" -o -name \"pagefile.sys\" -o -name \"KeePass.enforced*\" -o -name \"*vnc*.ini\" -o -name \"*.p12\" -o -name \".ldaprc\" -o -name \"*.keyring\" -o -name \"secrets.yml\" -o -name \"*.ovpn\" -o -name \"*password*\" -o -name \"*vnc*.txt\" -o -name \"authorized_hosts\" -o -name \"known_hosts\" -o -name \"*.viminfo\" -o -name \"gvm-tools.conf\" -o -name \"backups\" -o -name \"*.gnupg\" -o -name \"*.crt\" -o -name \"authorized_keys\" -o -name \"https.conf\" -o -name \"creds*\" -o -name \"database.php\" -o -name \"rsyncd.conf\" -o -name \"scclient.exe\" -o -name \"*.timer\" -o -name \"legacy_credentials.db\" -o -name \"security.sav\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.json\" -o -name \"SYSTEM\" -o -name \"pg_hba.conf\" -o -name \"gitlab.rm\" -o -name \"iis6.log\" -o -name \"*.rdg\" -o -name \"appcmd.exe\" -o -name \"*config*.php\" -o -name \"printers.xml\" -o -name \"ipsec.secrets\" -o -name \"ConsoleHost_history.txt\" -o -name \".*_history.*\" -o -name \"server.xml\" -o -name \"access.log\" -o -name \"sentry.conf.py\" -o -name \"sitemanager.xml\" -o -name \"my.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"*.socket\" -o -name \"gitlab.yml\" -o -name \"cesi.conf\" -o -name \"000-default.conf\" -o -name \"*.sqlite3\" -o -name \"*vnc*.c*nf*\" -o -name \".bashrc\" -o -name \"*.service\" -o -name \"azureProfile.json\" -o -name \"ftp.ini\" -o -name \".sudo_as_admin_successful\" -o -name \".gitconfig\" -o -name \"software.sav\" -o -name \"httpd.conf\" -o -name \"wp-config.php\" -o -name \"default.sav\" -o -name \"sess_*\" -o -name \"config.php\" -o -name \"tomcat-users.xml\" -o -name \".plan\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"credentials.db\" -o -name \".rhosts\" -o -name \"AppEvent.Evt\" -o -name \"anaconda-ks.cfg\" -o -name \"error.log\" -o -name \"sysprep.inf\" -o -name \"KeePass.ini\" -o -name \"NetSetup.log\" -o -name \"kibana.y*ml\" -o -name \"web*.config\" -o -name \"storage.php\" -o -name \"ftp.config\" -o -name \"SecEvent.Evt\" -o -name \"https-xampp.conf\" -o -name \".env\" -o -name \"my.ini\" -o -name \"redis.conf\" -o -name \"rsyncd.secrets\" -o -name \"unattended.xml\" -o -name \"wsl.exe\" -o -name \"racoon.conf\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"*.pem\" -o -name \"hostapd.conf\" -o -name \"ddclient.conf\" -o -name \".github\" -o -name \"index.dat\" -o -name \"kcpassword\" -o -name \"*.csr\" -o -name \".recently-used.xbel\" -o -name \".pypirc\" -o -name \"elasticsearch.y*ml\" -o -name \"datasources.xml\" -o -name \"drives.xml\" -o -name \"system.sav\" -o -name \"*vnc*.xml\" -o -name \"fastcgi_params\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"filezilla.xml\" -o -name \"access_tokens.db\" -o -name \".k5login\" -o -name \"*.der\" -o -name \".google_authenticator\" -o -name \"*.db\" -o -name \"mariadb.cnf\" -o -name \"bash.exe\" -o -name \"*.sqlite\" -o -name \"setupinfo.bak\" -o -name \"accessTokens.json\" -o -name \"kadm5.acl\" -o -name \"unattend.txt\" -o -name \"*credential*\" -o -name \"passwd\" -o -name \"*.kdbx\" -o -name \"sysprep.xml\" -o -name \"sites.ini\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.jks\" -o -name \"groups.xml\" -o -name \"autologin\" -o -name \"hosts.equiv\" -o -name \"winscp.ini\" -o -name \"AzureRMContext.json\" -o -name \"supervisord.conf\" -o -name \"RDCMan.settings\" -o -name \"recentservers.xml\" -o -name \"setupinfo\" -o -name \"ipsec.conf\" -o -name \".git-credentials\" -o -name \"protecteduserkey.bin\" -o -name \"SAM\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/sbin|^/media|^/.cache|^/run|^/bin|^/etc|^/srv|^/applications|^/mnt|^/sys|^/opt|^/lib32|^$GREPHOMESEARCH|^/private|^/snap|^/tmp|^/usr|^/system|^/systemd|^/var|^/lib64|^/lib|^/cdrom" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/sbin|^/media|^/.cache|^/run|^/bin|^/etc|^/srv|^/applications|^/mnt|^/sys|^/opt|^/lib32|^$GREPHOMESEARCH|^/private|^/snap|^/tmp|^/usr|^/system|^/systemd|^/var|^/lib64|^/lib|^/cdrom" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/sbin|^/media|^/.cache|^/run|^/bin|^/etc|^/srv|^/applications|^/mnt|^/sys|^/opt|^/lib32|^$GREPHOMESEARCH|^/private|^/snap|^/tmp|^/usr|^/system|^/systemd|^/var|^/lib64|^/lib|^/cdrom" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_2ND_GROUP"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_1ST_GROUP"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/mnt|^/var|^/private|^/tmp" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_1ST_GROUP"  | grep -E '/default/settings.php' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_1ST_GROUP"  | grep -E 'moodle/config.php' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/private|^/tmp" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^$GREPHOMESEARCH|^/usr" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_1ST_GROUP"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E '/lib' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E 'README.gnupg' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  PSTORAGE_FIREFOX=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^" | grep -E "\.mozilla$|Firefox$" | sort | uniq | head -n 70)
  PSTORAGE_CHROME=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^" | grep -E "google-chrome$|Chrome$" | sort | uniq | head -n 70)
  PSTORAGE_OPERA=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^" | grep -E "com\.operasoftware\.Opera$" | sort | uniq | head -n 70)
  PSTORAGE_SAFARI=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^" | grep -E "Safari$" | sort | uniq | head -n 70)
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/var|^/etc|^/usr" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_3RD_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_2ND_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_1ST_GROUP"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_1ST_GROUP"  | grep -E "^/mnt|^/sbin|^/media|^/.cache|^/opt|^$GREPHOMESEARCH|^/private|^/bin|^/snap|^/etc|^/srv|^/applications|^/tmp|^/var|^/usr|^/cdrom" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
