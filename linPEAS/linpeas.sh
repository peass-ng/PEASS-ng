...
if echo $CHECKS | grep -q procs_crons_timers_srvcs_sockets || echo $CHECKS | grep -q software_information || echo $CHECKS | grep -q interesting_files; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"bind\" -o -name \"filezilla\" -o -name \"system.d\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"pam.d\" -o -name \"system-connections\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"bind\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \".irssi\" -o -name \"cacti\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"ldap\" -o -name \"bind\" -o -name \"filezilla\" -o -name \"roundcube\" -o -name \"sentry\" -o -name \".svn\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"neo4j\" -o -name \".cloudflared\" -o -name \"zabbix\" -o -name \".password-store\" -o -name \"sites-enabled\" -o -name \".vnc\" -o -name \"couchdb\" -o -name \"logstash\" -o -name \"seeddms*\" -o -name \"postfix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"exports\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*knockd*\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"ssh*config\" -o -name \"docker-compose.yml\" -o -name \"access.log\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"sess_*\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"agent*\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"sess_*\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.service\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"agent*\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"sess_*\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"ssh*config\" -o -name \"docker-compose.yml\" -o -name \"access.log\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"Dockerfile\" -o -name \"KeePass.ini\" -o -name \"php.ini\" -o -name \"gvm-tools.conf\" -o -name \"hosts.equiv\" -o -name \".lesshst\" -o -name \".rhosts\" -o -name \"*.keyring\" -o -name \"winscp.ini\" -o -name \"postgresql.conf\" -o -name \"id_dsa*\" -o -name \"snmpd.conf\" -o -name \"database.php\" -o -name \"*.pfx\" -o -name \"cloud.cfg\" -o -name \"Ntds.dit\" -o -name \"mosquitto.conf\" -o -name \"autologin\" -o -name \"*.pgp\" -o -name \"https-xampp.conf\" -o -name \"software\" -o -name \"*.csr\" -o -name \"SAM\" -o -name \".git-credentials\" -o -name \"KeePass.config*\" -o -name \"psk.txt\" -o -name \"pgadmin*.db\" -o -name \"fastcgi_params\" -o -name \"zabbix_agentd.conf\" -o -name \"my.ini\" -o -name \".google_authenticator\" -o -name \".ldaprc\" -o -name \"*vnc*.txt\" -o -name \".bashrc\" -o -name \"drives.xml\" -o -name \"ftp.ini\" -o -name \"000-default.conf\" -o -name \"krb5.conf\" -o -name \"access_tokens.json\" -o -name \"access.log\" -o -name \"docker-compose.yml\" -o -name \"cesi.conf\" -o -name \".pypirc\" -o -name \"zabbix_server.conf\" -o -name \"passwd\" -o -name \"*.timer\" -o -name \"error.log\" -o -name \".msmtprc\" -o -name \"*vnc*.c*nf*\" -o -name \"rsyncd.secrets\" -o -name \"vault-ssh-helper.hcl\" -o -name \".htpasswd\" -o -name \"creds*\" -o -name \"authorized_hosts\" -o -name \"*.rdg\" -o -name \"id_rsa*\" -o -name \"ipsec.conf\" -o -name \"azureProfile.json\" -o -name \"groups.xml\" -o -name \"software.sav\" -o -name \"*.gnupg\" -o -name \"*.pem\" -o -name \"*_history*\" -o -name \"access_tokens.db\" -o -name \"known_hosts\" -o -name \"kcpassword\" -o -name \"AzureRMContext.json\" -o -name \"jetty-realm.properties\" -o -name \"pagefile.sys\" -o -name \".env\" -o -name \"setupinfo\" -o -name \"supervisord.conf\" -o -name \"unattended.xml\" -o -name \"mongod*.conf\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"krb5.keytab\" -o -name \"*.ovpn\" -o -name \"influxdb.conf\" -o -name \"credentials.db\" -o -name \".github\" -o -name \"sitemanager.xml\" -o -name \"docker.socket\" -o -name \"autologin.conf\" -o -name \"my.cnf\" -o -name \"*credential*\" -o -name \".vault-token\" -o -name \"recentservers.xml\" -o -name \".sudo_as_admin_successful\" -o -name \".erlang.cookie\" -o -name \"pg_hba.conf\" -o -name \"ftp.config\" -o -name \"storage.php\" -o -name \"*.kdbx\" -o -name \"racoon.conf\" -o -name \"scheduledtasks.xml\" -o -name \"backups\" -o -name \"*.sqlite\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"*.jks\" -o -name \"gitlab.yml\" -o -name \"protecteduserkey.bin\" -o -name \"elasticsearch.y*ml\" -o -name \"credentials\" -o -name \"system.sav\" -o -name \"printers.xml\" -o -name \"secrets.yml\" -o -name \"KeePass.enforced*\" -o -name \"ws_ftp.ini\" -o -name \"https.conf\" -o -name \"setupinfo.bak\" -o -name \"legacy_credentials.db\" -o -name \"*.sqlite3\" -o -name \".wgetrc\" -o -name \"accessTokens.json\" -o -name \"wp-config.php\" -o -name \"ddclient.conf\" -o -name \"*.service\" -o -name \"pgsql.conf\" -o -name \"*.gpg\" -o -name \"passbolt.php\" -o -name \"*.db\" -o -name \"ntuser.dat\" -o -name \"*config*.php\" -o -name \"*.ftpconfig\" -o -name \"bash.exe\" -o -name \"redis.conf\" -o -name \"web*.config\" -o -name \"sysprep.xml\" -o -name \".plan\" -o -name \"index.dat\" -o -name \"AppEvent.Evt\" -o -name \"TokenCache.dat\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"datasources.xml\" -o -name \"NetSetup.log\" -o -name \"scclient.exe\" -o -name \"server.xml\" -o -name \"sysprep.inf\" -o -name \"authorized_keys\" -o -name \"docker.sock\" -o -name \"*vnc*.ini\" -o -name \"settings.php\" -o -name \".git\" -o -name \".profile\" -o -name \"ipsec.secrets\" -o -name \"*password*\" -o -name \"*.der\" -o -name \"db.php\" -o -name \"*.psk\" -o -name \"mariadb.cnf\" -o -name \"unattend.xml\" -o -name \"*.key\" -o -name \"iis6.log\" -o -name \"hostapd.conf\" -o -name \"wsl.exe\" -o -name \"appcmd.exe\" -o -name \"config.php\" -o -name \"rsyncd.conf\" -o -name \"unattend.inf\" -o -name \"secrets.ldb\" -o -name \"sess_*\" -o -name \"*vnc*.xml\" -o -name \".recently-used.xbel\" -o -name \"unattend.txt\" -o -name \".secrets.mkey\" -o -name \"FreeSSHDservice.ini\" -o -name \"tomcat-users.xml\" -o -name \"*.swp\" -o -name \"debian.cnf\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"*.p12\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"ConsoleHost_history.txt\" -o -name \"wcx_ftp.ini\" -o -name \"security.sav\" -o -name \"*.crt\" -o -name \"httpd.conf\" -o -name \"sssd.conf\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"SYSTEM\" -o -name \"anaconda-ks.cfg\" -o -name \"SecEvent.Evt\" -o -name \"gitlab.rm\" -o -name \"kibana.y*ml\" -o -name \".gitconfig\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/run|^$GREPHOMESEARCH|^/srv|^/usr|^/sys|^/var|^/cdrom|^/snap|^/tmp|^/.cache|^/sbin|^/bin|^/systemd|^/private|^/opt|^/lib|^/lib64|^/applications|^/mnt|^/media|^/lib32|^/etc|^/system" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/run|^$GREPHOMESEARCH|^/srv|^/usr|^/sys|^/var|^/cdrom|^/snap|^/tmp|^/.cache|^/sbin|^/bin|^/systemd|^/private|^/opt|^/lib|^/lib64|^/applications|^/mnt|^/media|^/lib32|^/etc|^/system" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/run|^$GREPHOMESEARCH|^/srv|^/usr|^/sys|^/var|^/cdrom|^/snap|^/tmp|^/.cache|^/sbin|^/bin|^/systemd|^/private|^/opt|^/lib|^/lib64|^/applications|^/mnt|^/media|^/lib32|^/etc|^/system" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/mnt|^/private|^/tmp" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E '/default/settings.php' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E 'moodle/config.php' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/tmp" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/usr|^$GREPHOMESEARCH" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E '/lib' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E 'README.gnupg' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PRE_SHARED_KEYS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.psk$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/var|^/usr|^/etc" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN\n$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_PRIVATE\n$FIND_DIR_CDROM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_SBIN\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_SNAP\n$FIND_DIR_USR\n$FIND_DIR_MNT\n$FIND_DIR_OPT\n$FIND_DIR_VAR"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_MNT\n$FIND_SYSTEM\n$FIND_SRV\n$FIND_TMP\n$FIND_SBIN\n$FIND_APPLICATIONS\n$FIND_MEDIA\n$FIND_SYSTEMD\n$FIND_LIB\n$FIND_SYS\n$FIND_PRIVATE\n$FIND_ETC\n$FIND_VAR\n$FIND_OPT\n$FIND_SNAP\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CDROM\n$FIND_LIB64\n$FIND_RUN"  | grep -E "^/private|^/opt|^/snap|^/tmp|^/etc|^/.cache|^$GREPHOMESEARCH|^/applications|^/sbin|^/srv|^/bin|^/usr|^/cdrom|^/var|^/mnt|^/media" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
