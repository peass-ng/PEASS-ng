...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"cacti\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \".irssi\" -o -name \"sites-enabled\" -o -name \"system.d\" -o -name \"keyrings\" -o -name \"environments\" -o -name \"mysql\" -o -name \"filezilla\" -o -name \"sentry\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".svn\" -o -name \"postfix\" -o -name \"ldap\" -o -name \"seeddms*\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"cacti\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \"environments\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"mysql\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"postfix\" -o -name \"filezilla\" -o -name \"ldap\" -o -name \".bluemix\" -o -name \"sentry\" -o -name \"sites-enabled\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"cacti\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \".irssi\" -o -name \"sites-enabled\" -o -name \"keyrings\" -o -name \"environments\" -o -name \"mysql\" -o -name \"filezilla\" -o -name \"sentry\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".svn\" -o -name \"postfix\" -o -name \"ldap\" -o -name \"seeddms*\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"cacti\" -o -name \"neo4j\" -o -name \".vnc\" -o -name \".irssi\" -o -name \"sites-enabled\" -o -name \"keyrings\" -o -name \"environments\" -o -name \"mysql\" -o -name \"filezilla\" -o -name \"sentry\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"logstash\" -o -name \".cloudflared\" -o -name \".svn\" -o -name \"postfix\" -o -name \"ldap\" -o -name \"seeddms*\" -o -name \"couchdb\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"*knockd*\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"ssh*config\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"sess_*\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \"agent*\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"sess_*\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.timer\" -o -name \"*.socket\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \"agent*\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"sess_*\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"ssh*config\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"credentials.db\" -o -name \"mongod*.conf\" -o -name \"recentservers.xml\" -o -name \"KeePass.ini\" -o -name \"*.csr\" -o -name \"access.log\" -o -name \"azureProfile.json\" -o -name \"settings.php\" -o -name \"supervisord.conf\" -o -name \"tomcat-users.xml\" -o -name \"authorized_hosts\" -o -name \"fastcgi_params\" -o -name \"backup\" -o -name \"creds*\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"*.ovpn\" -o -name \"my.cnf\" -o -name \"postgresql.conf\" -o -name \"cloud.cfg\" -o -name \"kibana.y*ml\" -o -name \"sysprep.inf\" -o -name \"unattended.xml\" -o -name \"ftp.ini\" -o -name \"SYSTEM\" -o -name \"racoon.conf\" -o -name \"unattend.txt\" -o -name \"*.keystore\" -o -name \"pagefile.sys\" -o -name \".sudo_as_admin_successful\" -o -name \".pypirc\" -o -name \"*.key\" -o -name \"docker.socket\" -o -name \"system.sav\" -o -name \".github\" -o -name \"autologin.conf\" -o -name \"docker.sock\" -o -name \"wcx_ftp.ini\" -o -name \"drives.xml\" -o -name \"https.conf\" -o -name \"AzureRMContext.json\" -o -name \".rhosts\" -o -name \"*.pgp\" -o -name \"krb5.keytab\" -o -name \"*.jks\" -o -name \"ftp.config\" -o -name \"TokenCache.dat\" -o -name \"secrets.yml\" -o -name \"hosts.equiv\" -o -name \"psk.txt\" -o -name \"*config*.php\" -o -name \"iis6.log\" -o -name \"unattend.xml\" -o -name \"cesi.conf\" -o -name \"ntuser.dat\" -o -name \"KeePass.enforced*\" -o -name \"access_tokens.db\" -o -name \"software\" -o -name \".git-credentials\" -o -name \"*.db\" -o -name \"*vnc*.c*nf*\" -o -name \"*.p12\" -o -name \"*credential*\" -o -name \"*.kdbx\" -o -name \"security.sav\" -o -name \".htpasswd\" -o -name \"gitlab.rm\" -o -name \"*.swp\" -o -name \"kcpassword\" -o -name \"setupinfo\" -o -name \"ddclient.conf\" -o -name \"Dockerfile\" -o -name \"elasticsearch.y*ml\" -o -name \".*_history.*\" -o -name \"hostapd.conf\" -o -name \"scclient.exe\" -o -name \"sentry.conf.py\" -o -name \"RDCMan.settings\" -o -name \"sitemanager.xml\" -o -name \"protecteduserkey.bin\" -o -name \"server.xml\" -o -name \"*.der\" -o -name \"datasources.xml\" -o -name \".env\" -o -name \"id_dsa*\" -o -name \"wsl.exe\" -o -name \"ws_ftp.ini\" -o -name \".google_authenticator\" -o -name \"sysprep.xml\" -o -name \".profile\" -o -name \"groups.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.yml\" -o -name \".gitconfig\" -o -name \"*.socket\" -o -name \".erlang.cookie\" -o -name \"bash.exe\" -o -name \".lesshst\" -o -name \"pgsql.conf\" -o -name \"id_rsa*\" -o -name \"snmpd.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"*.gnupg\" -o -name \"FreeSSHDservice.ini\" -o -name \"index.dat\" -o -name \"web*.config\" -o -name \"known_hosts\" -o -name \"backups\" -o -name \".recently-used.xbel\" -o -name \"*password*\" -o -name \"redis.conf\" -o -name \"passwd\" -o -name \"ipsec.secrets\" -o -name \"php.ini\" -o -name \"*.sqlite\" -o -name \".ldaprc\" -o -name \"storage.php\" -o -name \"https-xampp.conf\" -o -name \"*vnc*.txt\" -o -name \"*.cer\" -o -name \"*.viminfo\" -o -name \"*.gpg\" -o -name \"vault-ssh-helper.hcl\" -o -name \"winscp.ini\" -o -name \".git\" -o -name \"rsyncd.conf\" -o -name \"software.sav\" -o -name \"*vnc*.xml\" -o -name \"config.php\" -o -name \".k5login\" -o -name \"appcmd.exe\" -o -name \"ipsec.conf\" -o -name \"Ntds.dit\" -o -name \"KeePass.config*\" -o -name \"printers.xml\" -o -name \"000-default.conf\" -o -name \"NetSetup.log\" -o -name \"*.pem\" -o -name \"*.timer\" -o -name \"access_tokens.json\" -o -name \"sites.ini\" -o -name \"default.sav\" -o -name \"krb5.conf\" -o -name \"accessTokens.json\" -o -name \"*.sqlite3\" -o -name \"*.ftpconfig\" -o -name \"*vnc*.ini\" -o -name \".bashrc\" -o -name \"database.php\" -o -name \"debian.cnf\" -o -name \"httpd.conf\" -o -name \"my.ini\" -o -name \"legacy_credentials.db\" -o -name \"*.rdg\" -o -name \"error.log\" -o -name \"*.service\" -o -name \"*.keyring\" -o -name \"setupinfo.bak\" -o -name \"pg_hba.conf\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"docker-compose.yml\" -o -name \"autologin\" -o -name \"gvm-tools.conf\" -o -name \"kadm5.acl\" -o -name \".msmtprc\" -o -name \"mariadb.cnf\" -o -name \"wp-config.php\" -o -name \"SecEvent.Evt\" -o -name \"pgadmin*.db\" -o -name \"SAM\" -o -name \".plan\" -o -name \"authorized_keys\" -o -name \".wgetrc\" -o -name \"unattend.inf\" -o -name \"sess_*\" -o -name \"mosquitto.conf\" -o -name \"scheduledtasks.xml\" -o -name \"credentials\" -o -name \"filezilla.xml\" -o -name \"ffftp.ini\" -o -name \"*.pfx\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/bin|^/lib64|^/cdrom|^/etc|^/opt|^$GREPHOMESEARCH|^/mnt|^/sys|^/.cache|^/private|^/media|^/srv|^/var|^/systemd|^/system|^/snap|^/applications|^/tmp|^/usr|^/lib|^/lib32|^/run|^/sbin" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/bin|^/lib64|^/cdrom|^/etc|^/opt|^$GREPHOMESEARCH|^/mnt|^/sys|^/.cache|^/private|^/media|^/srv|^/var|^/systemd|^/system|^/snap|^/applications|^/tmp|^/usr|^/lib|^/lib32|^/run|^/sbin" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/bin|^/lib64|^/cdrom|^/etc|^/opt|^$GREPHOMESEARCH|^/mnt|^/sys|^/.cache|^/private|^/media|^/srv|^/var|^/systemd|^/system|^/snap|^/applications|^/tmp|^/usr|^/lib|^/lib32|^/run|^/sbin" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/tmp|^/mnt|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E '/default/settings.php' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E 'moodle/config.php' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/tmp|^/private" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/usr|^$GREPHOMESEARCH" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E '/lib' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E 'README.gnupg' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/var|^/etc|^/usr" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_SRV\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MNT\n$FIND_DIR_USR\n$FIND_DIR_MEDIA\n$FIND_DIR_PRIVATE\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_CDROM\n$FIND_DIR_ETC\n$FIND_DIR_BIN"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_LIB\n$FIND_ETC\n$FIND_PRIVATE\n$FIND_VAR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_LIB64\n$FIND_HOMESEARCH\n$FIND_SBIN\n$FIND_SNAP\n$FIND_MEDIA\n$FIND_SRV\n$FIND_SYSTEMD\n$FIND_BIN\n$FIND_RUN\n$FIND_LIB32\n$FIND_OPT\n$FIND_CDROM\n$FIND_TMP\n$FIND_CACHE\n$FIND_USR\n$FIND_MNT\n$FIND_SYSTEM"  | grep -E "^/mnt|^/tmp|^/snap|^/bin|^/.cache|^/cdrom|^/private|^/media|^/srv|^/var|^/etc|^/applications|^/usr|^/opt|^/sbin|^$GREPHOMESEARCH" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
