...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"system.d\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"bind\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"mysql\" -o -name \"roundcube\" -o -name \"cacti\" -o -name \".vnc\" -o -name \"filezilla\" -o -name \"seeddms*\" -o -name \"neo4j\" -o -name \"keyrings\" -o -name \"sites-enabled\" -o -name \".cloudflared\" -o -name \".irssi\" -o -name \"environments\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"postfix\" -o -name \"sentry\" -o -name \".svn\" -o -name \"couchdb\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \"sess_*\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \"sess_*\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"agent*\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.socket\" -o -name \"*.timer\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_USR=`eval_bckgrd "find /usr -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"ssh*config\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"wp-config.php\" -o -name \"*vnc*.c*nf*\" -o -name \"my.cnf\" -o -name \"*.viminfo\" -o -name \"authorized_hosts\" -o -name \"access_tokens.json\" -o -name \"access_tokens.db\" -o -name \"sess_*\" -o -name \".sudo_as_admin_successful\" -o -name \"debian.cnf\" -o -name \"appcmd.exe\" -o -name \"azureProfile.json\" -o -name \"ipsec.conf\" -o -name \"ftp.ini\" -o -name \"ftp.config\" -o -name \"unattend.inf\" -o -name \"setupinfo.bak\" -o -name \"autologin\" -o -name \"SYSTEM\" -o -name \"datasources.xml\" -o -name \"kcpassword\" -o -name \"*config*.php\" -o -name \"AzureRMContext.json\" -o -name \"*.der\" -o -name \"winscp.ini\" -o -name \"mongod*.conf\" -o -name \"server.xml\" -o -name \"legacy_credentials.db\" -o -name \"sites.ini\" -o -name \"gitlab.rm\" -o -name \"protecteduserkey.bin\" -o -name \"redis.conf\" -o -name \"*.p12\" -o -name \"fastcgi_params\" -o -name \"*.socket\" -o -name \"Ntds.dit\" -o -name \"snmpd.conf\" -o -name \"elasticsearch.y*ml\" -o -name \"wsl.exe\" -o -name \"pgsql.conf\" -o -name \".wgetrc\" -o -name \"hosts.equiv\" -o -name \"httpd.conf\" -o -name \"*password*\" -o -name \"tomcat-users.xml\" -o -name \".ldaprc\" -o -name \"influxdb.conf\" -o -name \".lesshst\" -o -name \"*.csr\" -o -name \"ConsoleHost_history.txt\" -o -name \"hostapd.conf\" -o -name \"credentials.db\" -o -name \"supervisord.conf\" -o -name \"mosquitto.conf\" -o -name \"NetSetup.log\" -o -name \"*.keystore\" -o -name \"cloud.cfg\" -o -name \"gvm-tools.conf\" -o -name \"TokenCache.dat\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \".msmtprc\" -o -name \"iis6.log\" -o -name \"*.pgp\" -o -name \"pagefile.sys\" -o -name \"rsyncd.conf\" -o -name \"index.dat\" -o -name \"psk.txt\" -o -name \"docker.sock\" -o -name \"vault-ssh-helper.hcl\" -o -name \"cesi.conf\" -o -name \".htpasswd\" -o -name \"https.conf\" -o -name \".bashrc\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"bash.exe\" -o -name \"*.service\" -o -name \"anaconda-ks.cfg\" -o -name \"passwd\" -o -name \"sitemanager.xml\" -o -name \"*.cer\" -o -name \"KeePass.ini\" -o -name \"ffftp.ini\" -o -name \"*.sqlite3\" -o -name \"docker.socket\" -o -name \"sentry.conf.py\" -o -name \"postgresql.conf\" -o -name \"autologin.conf\" -o -name \"sssd.conf\" -o -name \"accessTokens.json\" -o -name \"scheduledtasks.xml\" -o -name \"*.pem\" -o -name \"wcx_ftp.ini\" -o -name \"passbolt.php\" -o -name \"krb5.keytab\" -o -name \"ipsec.secrets\" -o -name \"*.ftpconfig\" -o -name \"SAM\" -o -name \"krb5.conf\" -o -name \"kibana.y*ml\" -o -name \"settings.php\" -o -name \"config.php\" -o -name \"gitlab.yml\" -o -name \"KeePass.config*\" -o -name \"scclient.exe\" -o -name \"web*.config\" -o -name \"*.timer\" -o -name \"software\" -o -name \"drives.xml\" -o -name \"*.gpg\" -o -name \".*_history.*\" -o -name \"recentservers.xml\" -o -name \"*.crt\" -o -name \"database.php\" -o -name \"*.gnupg\" -o -name \"security.sav\" -o -name \"*.key\" -o -name \"setupinfo\" -o -name \"pgadmin*.db\" -o -name \"secrets.ldb\" -o -name \"printers.xml\" -o -name \".plan\" -o -name \".profile\" -o -name \"*.ovpn\" -o -name \"unattended.xml\" -o -name \".gitconfig\" -o -name \"*.jks\" -o -name \".pypirc\" -o -name \"*credential*\" -o -name \"*vnc*.xml\" -o -name \"*.keyring\" -o -name \"*.rdg\" -o -name \"unattend.xml\" -o -name \"authorized_keys\" -o -name \"known_hosts\" -o -name \"creds*\" -o -name \"*.pfx\" -o -name \"000-default.conf\" -o -name \"docker-compose.yml\" -o -name \"ntuser.dat\" -o -name \".k5login\" -o -name \"filezilla.xml\" -o -name \"groups.xml\" -o -name \"system.sav\" -o -name \"*.swp\" -o -name \"KeePass.enforced*\" -o -name \"*.sqlite\" -o -name \"error.log\" -o -name \"sysprep.xml\" -o -name \".rhosts\" -o -name \"FreeSSHDservice.ini\" -o -name \"backup\" -o -name \"ws_ftp.ini\" -o -name \"mariadb.cnf\" -o -name \"backups\" -o -name \"unattend.txt\" -o -name \"access.log\" -o -name \"software.sav\" -o -name \"storage.php\" -o -name \"*vnc*.ini\" -o -name \".env\" -o -name \".git\" -o -name \".secrets.mkey\" -o -name \"https-xampp.conf\" -o -name \"racoon.conf\" -o -name \"RDCMan.settings\" -o -name \"secrets.yml\" -o -name \".vault-token\" -o -name \"Dockerfile\" -o -name \".recently-used.xbel\" -o -name \".google_authenticator\" -o -name \"pg_hba.conf\" -o -name \"id_dsa*\" -o -name \"*vnc*.txt\" -o -name \".github\" -o -name \"php.ini\" -o -name \"*.db\" -o -name \".erlang.cookie\" -o -name \"my.ini\" -o -name \"credentials\" -o -name \"*.kdbx\" -o -name \"SecEvent.Evt\" -o -name \"db.php\" -o -name \"AppEvent.Evt\" -o -name \"sysprep.inf\" -o -name \"id_rsa*\" -o -name \"rsyncd.secrets\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/applications|^/lib64|^/.cache|^/mnt|^/cdrom|^/lib|^/lib32|^/system|^/run|^/private|^/etc|^/opt|^/media|^/sbin|^/systemd|^/bin|^/usr|^/snap|^/sys|^/tmp|^/srv|^$GREPHOMESEARCH" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/applications|^/lib64|^/.cache|^/mnt|^/cdrom|^/lib|^/lib32|^/system|^/run|^/private|^/etc|^/opt|^/media|^/sbin|^/systemd|^/bin|^/usr|^/snap|^/sys|^/tmp|^/srv|^$GREPHOMESEARCH" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/applications|^/lib64|^/.cache|^/mnt|^/cdrom|^/lib|^/lib32|^/system|^/run|^/private|^/etc|^/opt|^/media|^/sbin|^/systemd|^/bin|^/usr|^/snap|^/sys|^/tmp|^/srv|^$GREPHOMESEARCH" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/tmp|^/mnt|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E '/default/settings.php' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E 'moodle/config.php' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/tmp|^/private" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^$GREPHOMESEARCH|^/usr" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_KERBEROS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E '/lib' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E 'README.gnupg' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/usr" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_HOMESEARCH\n$FIND_DIR_VAR\n$FIND_DIR_TMP\n$FIND_DIR_SRV\n$FIND_DIR_OPT\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_SNAP\n$FIND_DIR_ETC\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_MEDIA\n$FIND_DIR_CDROM\n$FIND_DIR_CACHE"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_DATABASE=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_APPLICATIONS\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_SYS\n$FIND_TMP\n$FIND_SNAP\n$FIND_USR\n$FIND_BIN\n$FIND_SYSTEMD\n$FIND_VAR\n$FIND_CDROM\n$FIND_OPT\n$FIND_CACHE\n$FIND_MNT\n$FIND_HOMESEARCH\n$FIND_ETC\n$FIND_LIB\n$FIND_MEDIA\n$FIND_PRIVATE\n$FIND_RUN\n$FIND_SBIN"  | grep -E "^/var|^/etc|^/snap|^/applications|^/.cache|^/cdrom|^/opt|^/media|^/tmp|^$GREPHOMESEARCH|^/sbin|^/srv|^/bin|^/mnt|^/private|^/usr" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
