...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"pam.d\" -o -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \"sites-enabled\" -o -name \".bluemix\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"system.d\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"system-connections\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \"bind\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \"bind\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"environments\" -o -name \"neo4j\" -o -name \".password-store\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"sites-enabled\" -o -name \"roundcube\" -o -name \"postfix\" -o -name \"couchdb\" -o -name \"zabbix\" -o -name \"logstash\" -o -name \".irssi\" -o -name \"sentry\" -o -name \"seeddms*\" -o -name \"filezilla\" -o -name \"mysql\" -o -name \"keyrings\" -o -name \"ldap\" -o -name \".svn\" -o -name \"cacti\" -o -name \"bind\" -o -name \".cloudflared\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"exports\" -o -name \"AzureRMContext.json\" -o -name \"krb5.keytab\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*knockd*\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"ssh*config\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"sess_*\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"agent*\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"sess_*\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"agent*\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"sess_*\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"ssh*config\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"ffftp.ini\" -o -name \"zabbix_agentd.conf\" -o -name \"creds*\" -o -name \".recently-used.xbel\" -o -name \"recentservers.xml\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sites.ini\" -o -name \"*.pem\" -o -name \"krb5.keytab\" -o -name \"AzureRMContext.json\" -o -name \"ftp.ini\" -o -name \"redis.conf\" -o -name \"credentials.db\" -o -name \".gitconfig\" -o -name \"my.ini\" -o -name \"ftp.config\" -o -name \"postgresql.conf\" -o -name \"anaconda-ks.cfg\" -o -name \"ntuser.dat\" -o -name \"printers.xml\" -o -name \"pgadmin*.db\" -o -name \"storage.php\" -o -name \"credentials\" -o -name \"RDCMan.settings\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"TokenCache.dat\" -o -name \"ipsec.secrets\" -o -name \"settings.php\" -o -name \"winscp.ini\" -o -name \"autologin\" -o -name \"mosquitto.conf\" -o -name \"scclient.exe\" -o -name \"*.pfx\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"*password*\" -o -name \"sysprep.inf\" -o -name \"autologin.conf\" -o -name \"setupinfo.bak\" -o -name \"access_tokens.json\" -o -name \"authorized_hosts\" -o -name \".k5login\" -o -name \"https-xampp.conf\" -o -name \"krb5.conf\" -o -name \"passwd\" -o -name \"wp-config.php\" -o -name \".google_authenticator\" -o -name \"wsl.exe\" -o -name \"*.viminfo\" -o -name \".github\" -o -name \"error.log\" -o -name \".plan\" -o -name \"*.service\" -o -name \"unattend.inf\" -o -name \"pagefile.sys\" -o -name \"*.ftpconfig\" -o -name \"https.conf\" -o -name \"httpd.conf\" -o -name \"passbolt.php\" -o -name \".pypirc\" -o -name \"access.log\" -o -name \"KeePass.ini\" -o -name \"elasticsearch.y*ml\" -o -name \"cesi.conf\" -o -name \"server.xml\" -o -name \"known_hosts\" -o -name \"SAM\" -o -name \"unattend.xml\" -o -name \".htpasswd\" -o -name \"id_rsa*\" -o -name \"security.sav\" -o -name \"fastcgi_params\" -o -name \"datasources.xml\" -o -name \"psk.txt\" -o -name \"Dockerfile\" -o -name \"influxdb.conf\" -o -name \"snmpd.conf\" -o -name \"mongod*.conf\" -o -name \"rsyncd.secrets\" -o -name \"*_history*\" -o -name \"hosts.equiv\" -o -name \"authorized_keys\" -o -name \"mariadb.cnf\" -o -name \".env\" -o -name \"ddclient.conf\" -o -name \"*credential*\" -o -name \"ipsec.conf\" -o -name \"KeePass.config*\" -o -name \"FreeSSHDservice.ini\" -o -name \"000-default.conf\" -o -name \"legacy_credentials.db\" -o -name \"*.pgp\" -o -name \"system.sav\" -o -name \"kibana.y*ml\" -o -name \"sitemanager.xml\" -o -name \"sssd.conf\" -o -name \"SYSTEM\" -o -name \"*.sqlite\" -o -name \"default.sav\" -o -name \"rsyncd.conf\" -o -name \"KeePass.enforced*\" -o -name \"NetSetup.log\" -o -name \"*.ovpn\" -o -name \"db.php\" -o -name \"*.gnupg\" -o -name \"supervisord.conf\" -o -name \"id_dsa*\" -o -name \"jetty-realm.properties\" -o -name \"groups.xml\" -o -name \"*vnc*.xml\" -o -name \"setupinfo\" -o -name \"unattended.xml\" -o -name \"docker.sock\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"*.crt\" -o -name \".git\" -o -name \"scheduledtasks.xml\" -o -name \"*.sqlite3\" -o -name \"azureProfile.json\" -o -name \"*.gpg\" -o -name \"accessTokens.json\" -o -name \"sysprep.xml\" -o -name \"pg_hba.conf\" -o -name \"*.kdbx\" -o -name \"ConsoleHost_history.txt\" -o -name \"gitlab.rm\" -o -name \"index.dat\" -o -name \"wcx_ftp.ini\" -o -name \"appcmd.exe\" -o -name \"my.cnf\" -o -name \"zabbix_server.conf\" -o -name \"*.swp\" -o -name \"database.php\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"unattend.txt\" -o -name \"bash.exe\" -o -name \"pgsql.conf\" -o -name \"gvm-tools.conf\" -o -name \".lesshst\" -o -name \"kcpassword\" -o -name \"sentry.conf.py\" -o -name \"*.p12\" -o -name \"*vnc*.ini\" -o -name \"gitlab.yml\" -o -name \"Ntds.dit\" -o -name \".wgetrc\" -o -name \".bashrc\" -o -name \"*config*.php\" -o -name \"secrets.ldb\" -o -name \".sudo_as_admin_successful\" -o -name \"backups\" -o -name \".secrets.mkey\" -o -name \"secrets.yml\" -o -name \"docker.socket\" -o -name \"ws_ftp.ini\" -o -name \"cloud.cfg\" -o -name \"sess_*\" -o -name \"SecEvent.Evt\" -o -name \"*.db\" -o -name \".vault-token\" -o -name \"AppEvent.Evt\" -o -name \"iis6.log\" -o -name \"*.key\" -o -name \"*vnc*.c*nf*\" -o -name \"*.keyring\" -o -name \"docker-compose.yml\" -o -name \"access_tokens.db\" -o -name \".erlang.cookie\" -o -name \"*.rdg\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"config.php\" -o -name \"backup\" -o -name \"drives.xml\" -o -name \".ldaprc\" -o -name \"*.der\" -o -name \".msmtprc\" -o -name \".rhosts\" -o -name \"software\" -o -name \"filezilla.xml\" -o -name \"hostapd.conf\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \".profile\" -o -name \"debian.cnf\" -o -name \"protecteduserkey.bin\" -o -name \"*vnc*.txt\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/.cache|^/system|^/media|^/cdrom|^/bin|^$GREPHOMESEARCH|^/lib|^/systemd|^/etc|^/var|^/snap|^/sys|^/private|^/run|^/tmp|^/lib64|^/srv|^/mnt|^/lib32|^/applications|^/sbin|^/usr|^/opt" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/.cache|^/system|^/media|^/cdrom|^/bin|^$GREPHOMESEARCH|^/lib|^/systemd|^/etc|^/var|^/snap|^/sys|^/private|^/run|^/tmp|^/lib64|^/srv|^/mnt|^/lib32|^/applications|^/sbin|^/usr|^/opt" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/.cache|^/system|^/media|^/cdrom|^/bin|^$GREPHOMESEARCH|^/lib|^/systemd|^/etc|^/var|^/snap|^/sys|^/private|^/run|^/tmp|^/lib64|^/srv|^/mnt|^/lib32|^/applications|^/sbin|^/usr|^/opt" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/mnt|^/tmp|^/private" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E '/default/settings.php' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E 'moodle/config.php' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/private" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^$GREPHOMESEARCH|^/usr" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E '/lib' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E 'README.gnupg' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/var|^/etc|^/usr" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR\n$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_MEDIA\n$FIND_DIR_ETC\n$FIND_DIR_SBIN\n$FIND_DIR_USR\n$FIND_DIR_PRIVATE\n$FIND_DIR_VAR\n$FIND_DIR_MNT\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CACHE\n$FIND_DIR_SNAP\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_TMP\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_SRV"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_PRIVATE\n$FIND_TMP\n$FIND_SBIN\n$FIND_CDROM\n$FIND_CACHE\n$FIND_HOMESEARCH\n$FIND_OPT\n$FIND_LIB32\n$FIND_LIB64\n$FIND_SRV\n$FIND_LIB\n$FIND_SNAP\n$FIND_RUN\n$FIND_BIN\n$FIND_MNT\n$FIND_USR\n$FIND_APPLICATIONS\n$FIND_SYS\n$FIND_SYSTEMD\n$FIND_ETC\n$FIND_SYSTEM\n$FIND_MEDIA\n$FIND_VAR"  | grep -E "^/tmp|^/srv|^/etc|^/mnt|^/.cache|^/var|^/sbin|^/snap|^/media|^/applications|^/usr|^/opt|^/cdrom|^/bin|^$GREPHOMESEARCH|^/private" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
